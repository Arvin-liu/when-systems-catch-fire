...
- [推理 / Derived](#function-level-derived-function)：488 条 / 488 entries
...
<a id="function-level-derived-function-d520"></a>
<details>
<summary>新增：D520 元竞争动力学函数（抽象版）</summary>
...
**数学表达 / Mathematical Expression**
中文：W(S)=∫_S H² dA, min_{S:亏格g} W(S)=2π² (g=1)，环面达到Willmore能量极小点
English: W(S)=∫_S H² dA, min_{S:genus g} W(S)=2π² (g=1), the torus attains the Willmore energy minimum


**数学推导过程 / Mathematical Derivation**
- 对象 / Object: `F_D522`
- 类型 / Type: 推论函数
- 定义域 / Domain: `X_D522 = {S ∈ Smooth Surface | S is a compact oriented surface of genus g}`
...
- 收敛判据 / Convergence: `Converged(F_D522) ⇔ ΔF_D522=∅ ∧ (J_n^+,J_n^-)=(1,0)`
...
**数学表达 / Mathematical Expression**
中文：∀n>1，n>4.55时熵跃迁，∃p∈ℙ: n²<p<(n+1)²
English: ∀n>1: when n>4.55, entropy jump, ∃p∈ℙ: n²<p<(n+1)²


**数学推导过程 / Mathematical Derivation**
- 对象 / Object: `F_D532`
- 类型 / Type: 推论函数
- 定义域 / Domain: `X_D532 = {n ∈ ℕ⁺ | n>1}`
- 值域 / Codomain: `Y_D532 = {b ∈ {0,1} | ∃prime between n² and (n+1)²}`
- 数学表达 / Expression: `F_D532(n) := 1[n>4.55 → ∃p: n²<p<(n+1)²], dependent on T31 entropy jump`
...
- 收敛判据 / Convergence: `Converged(F_D532) ⇔ ΔF_D532=∅ ∧ (J_n^+,J_n^-)=(1,0)`
...
**数学表达 / Mathematical Expression**
中文：执念O触发逃避行为E(O)>0，逃避行为本身成为新的执念源O'=E(O)，形成二阶逃避：E'(E(O))>0，系统进入反射循环
English: Obsession O triggers escape E(O)>0, escape itself becomes new obsession O'=E(O), forming second-order escape: E'(E(O))>0, system enters reflexive cycle


**数学推导过程 / Mathematical Derivation**
- 对象 / Object: `F_D540`
- 类型 / Type: 推论函数
- 定义域 / Domain: `X_D540 = {o ∈ ObsessionState | o triggers escape mechanism}`
- 值域 / Codomain: `Y_D540 = {e ∈ ℝ⁺ | escape intensity}`
- 数学表达 / Expression: `F_D540(o) := e_1=E(o), e_2=E'(e_1)=E'(E(o)), e_2>e_1>0 (second-order escape loop)`
- 有效条件 / Validity: `J_n^+(F_D540)=1 ∧ J_n^-(F_D540)=0`
- 推导类型 / Derivation type: `bootstrapped_derivation`
- 收敛状态 / Convergence status: `converged`
- 依赖 / Depends on: `D1, D39`
- 推导步骤 / Steps:
  - 1. Define the local state space X_{D540} and codomain Y_{D540}.
  - 2. Normalize the source expression as F_{D540}: X_{D540}->Y_{D540}.
  - 3. Apply Y1 bootstrap judgment: J⁺=1 (C_unified≥0.6, M_boot≥0.6) and J⁻=0.
