...
id: "D419"
raw_id: "D419"
title: "宏观僵尸态-实际不可逆等价函数"
source: "统一函数总表 D层(推论层) 第5批 D361-D450 2026.06.30版"
source_line: 18240
link: "docs/zh/functions/items/D419.md"
---
...
**注释 / Annotation**
M9的宏观僵尸态、实际不可逆、缓冲不可逆([D309](docs/zh/functions/items/D309.md))三者精确等价——同一现象的三个等价描述。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一函数总表/0455-D419-宏观僵尸态-实际不可逆等价函数.md`
