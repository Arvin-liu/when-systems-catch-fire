...
source_line: 15909
link: "docs/zh/functions/items/D360.md"
---
...
**注释 / Annotation**
M5的弱容斥主导区是否在不可逆线之前取决于n。n小时弱容斥=不可逆（无窗口），n大时有"容斥主导但还可逆"窗口，宽度∝(√n-1)/n∝[D310](docs/zh/functions/items/D310.md)。大系统有"容斥主导但还有救"的窗口，小系统没有。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一函数总表/0396-D360-弱容斥-不可逆边界函数.md`
