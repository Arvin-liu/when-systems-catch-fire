...
source_line: 19303
link: "docs/zh/functions/items/D483.md"
---

### [D483｜认知最大可估空间函数](docs/zh/functions/items/D483.md)
...
**注释 / Annotation**
Ω_cognitive_max = {x | E[r](x) 和 Var(r)(x) 可准确估计}
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一函数总表/0481-D483-认知最大可估空间函数.md`
