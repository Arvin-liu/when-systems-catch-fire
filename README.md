...
- 任务 101 迁移后重算的全语料非函数断言注册表登记了 **17,259** 个 canonical claim；其中 **5,546** 个处于显式 quarantine 或 pending，公开表面违规为 **0**。这些计数会随受治理语料变化，是仓库审计结果，不是对断言真实性的统计证明。
...
- 17,259 个非函数断言中哪些应优先补证，哪些应长期保持历史记录或隔离？
