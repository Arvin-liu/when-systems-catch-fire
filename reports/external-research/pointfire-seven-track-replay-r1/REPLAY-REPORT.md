...
Status: `OWNER_ACCEPTED_BOUNDED_REPLAY_RESULT_WITH_EXPLICIT_RESIDUALS`
...
Baseline artifact: the blinded-baseline public handoff used for this replay; private source receipts are withheld.
...
The replay does not establish EPISTEMICALLY_ACCEPTED. The independent adversarial review and fresh rereview passed after repairs to source metadata, exposure pooling, outcome typing, source-family roles, and causal audit fields; detailed reviewer receipts are retained privately. The remaining limits are substantive scope limits, not a claim of universal external validity.

## Provenance

- Formal replay base: when-systems-catch-fire/main at immutable tip e5c6d1d0b75dae41b414474bc22747816cd00c78.
- Preregistration and blinded-baseline source receipts were frozen before this pass; private source paths, bodies, and hashes are withheld from the public artifact.
- Machine-readable ledgers are in the adjacent data directory.
- Owner decision: `ACCEPT_BOUNDED_REPLAY_RESULT_WITH_EXPLICIT_RESIDUALS`; architecture value remains `MIXED_VALUE_WITH_COST_OR_UNDERDETERMINED`.
- `EPISTEMICALLY_ACCEPTED=0`; external validity remains `NOT_ESTABLISHED`.
