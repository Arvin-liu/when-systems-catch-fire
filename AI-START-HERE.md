...
若任务涉及 L6 公共故事或文章，还应读取 `docs/publication/embodied-cognitive-leap-writing-method.md` 与对应后台规格。121Q28 未经独立审查和合并前只是一项 Draft 候选，不是当前能力。
...
- 使用 121Q28 候选时，必须落实“在下一层中写当前层”、双重归属铰链、回照增义和信息增益停止，并保留肉身成本与 Charter Gate 主体。
- 效果推理只产生行动候选，不产生真值。
