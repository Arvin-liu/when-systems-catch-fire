...
- Q32I 的 1.3.0 Draft candidate 只在完整 profile、authority、plan 与指纹身份一致时选择性物化。NonImpactProof 只证明声明关系范围内的非影响；cache 不是真相源；meta-authority 变更强制 full rebuild。未经独立审查、merge 和 closeout 前不得称为 Current。
