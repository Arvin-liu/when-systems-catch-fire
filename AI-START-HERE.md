...
2. ARCHITECTURE.md：现行七层架构权威；121Q12 双环是跨层操作 overlay，不是新真值层。
3. FOUNDATION.md：数学与逻辑双地基。
4. llms.txt：机器可读边界。
5. AI-HANDOFF.md：当前权威、兼容和任务交接。
6. data/foundation/project-state.json 与 registry-manifest.json：机器状态。
7. 当前任务命令与相关 source/schema。
