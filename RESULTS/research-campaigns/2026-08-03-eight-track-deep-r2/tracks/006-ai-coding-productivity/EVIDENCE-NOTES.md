...
- [arXiv:2507.09089](https://arxiv.org/abs/2507.09089) 的当前 PDF 也已全文打开，51 页，SHA-256：`3e18d9e097a3163dbae662e8b7c68ace0510be433891994b136ae7730beab25c`；它同样写出“27 个未审查 issue”。这与 METR 站点 50 页 PDF 和当前仓库 CSV 的计数差异都没有被本轮擅自改写成同一版本。
...
- [Management Science 在线附录](https://pubsonline.informs.org/doi/suppl/10.1287/mnsc.2025.00535) 的 15 页正文已通过网页全文打开，包含数据清理、早期 ITT、动态效果和三企业差异；但与之配套的 replication files 下载入口要求同意政策并填写姓名、机构和邮箱。本轮未提交该表单，也没有声称取得原始 developer-week 数据。因此不声称“复算了 Microsoft 26.08%”，只做公开正文与附录的方法、分母和结果层审计。
