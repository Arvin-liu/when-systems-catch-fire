...
def new_case(
    *,
    ...
    summary = copy.deepcopy(dict(question_summary))
...
def amend_question(
    ...
    *,
    ...
    new_summary = copy.deepcopy(dict(summary))
    current_digest = question["question_digest"]
    next_digest = sha256_json(new_summary)
    question["summary"] = new_summary
    question["question_digest"] = next_digest
    question["version"] += 1
