...
def build_parser() -> argparse.ArgumentParser:
    ...
    init.add_argument("--question-ref", required=True)
    init.add_argument("--question-summary", required=True, help="JSON file containing the frozen summary")
    ...
    try:
        if args.command == "init":
            ...
            document = new_case(
                ...
                question_summary=_json_file(args.question_summary),
