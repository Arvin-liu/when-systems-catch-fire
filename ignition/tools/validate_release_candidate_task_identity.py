#!/usr/bin/env python3
"""Fail-closed release-candidate task identity and ordinal gate for IGNITION-135."""
...
PROGRESS_PATH = ROOT / "data/operations/iterations/135/progress.jsonl"
RESULT_PATH = ROOT / "agent-results/IGNITION-20260822-135-result.md"
...
def load_result_task(path: Path) -> str | None:
    ...
    for line in path.read_text(encoding="utf-8").splitlines():
        ...
        if "IGNITION-20260822-135" in line and "#" not in line:
...
def validate_documents(
    *,
    ...
    if not progress:
        ...
        if last.get("current_iteration_id") != 135:
