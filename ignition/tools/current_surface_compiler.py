...
def render_block(snapshot: dict[str, Any], profile: str) -> str:
    ...
    if profile == "machine":
        ...
        lines = [
            ...
            f"- current_map: `{map_data['current_version']}` Current；historical_map: `{map_data['historical_versions'][0]}` Historical。",
