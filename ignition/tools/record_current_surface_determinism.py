...
TASK_ID = _lineage["task_identity"]["current_formal_task"]
ORDINAL = int(TASK_ID.rsplit("-", 1)[1])
REPORT_PATH = ROOT / f"data/operations/iterations/{ORDINAL}/step15-deterministic-current-surface-r1.json"
REPORT_SCHEMA = f"ignition-{ORDINAL}-step15-deterministic-current-surface-r1"
OUTPUTS = [
    ...
    f"ignition/data/operations/iterations/{ORDINAL}/execution-contract-r1.json",
    ".github/README.md",
