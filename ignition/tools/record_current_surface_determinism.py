...
REPORT_PATH = ROOT / "data/operations/iterations/134/step14-deterministic-current-surface-r1.json"
TASK_ID = "IGNITION-20260822-134"
REPORT_SCHEMA = "ignition-134-step14-deterministic-current-surface-r1"
OUTPUTS = [
