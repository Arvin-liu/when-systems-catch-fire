...
REPORT_PATH = ROOT / "data/operations/iterations/134/step13-deterministic-current-surface-r1.json"
TASK_ID = "IGNITION-20260822-134"
REPORT_SCHEMA = "ignition-134-step13-deterministic-current-surface-r1"
OUTPUTS = [
    ...
    "ignition/data/operations/iterations/134/execution-contract-r1.json",
    ".github/README.md",
