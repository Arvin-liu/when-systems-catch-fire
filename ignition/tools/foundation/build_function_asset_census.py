...
# isolated production fixtures may copy the application into a temporary Git
# worktree root.  History/path enumeration must follow whichever root owns
# ``.git``.
...
GENERATED_EXACT_PATHS = {
    ...
    "data/operations/iterations/113/FINAL_STATE.json",
