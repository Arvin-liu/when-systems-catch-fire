...
ISSUE_FORMS = {
    "independent_review": REPO_ROOT / ".github/ISSUE_TEMPLATE/independent-review.yml",
    "noncommercial_use": REPO_ROOT / ".github/ISSUE_TEMPLATE/noncommercial-use-report.yml",
    "sponsorship_or_commercial_license_inquiry": REPO_ROOT / ".github/ISSUE_TEMPLATE/sponsorship-or-commercial-license-inquiry.yml",
}

TEXT_FILES = [
    REPO_ROOT / ".github/README.md",
    REPO_ROOT / ".github/SUPPORT.md",
...
def read(path: Path) -> str:
    ...
    require(path.exists(), f"missing required file: {display}")
...
def validate_support_boundary() -> None:
    readme = read(REPO_ROOT / ".github/README.md").lower()
    support = read(REPO_ROOT / ".github/SUPPORT.md").lower()
