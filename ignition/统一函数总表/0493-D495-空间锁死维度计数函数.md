...
source_line: 19812
link: "docs/zh/functions/items/D495.md"
---

### [D495｜空间锁死维度计数函数](docs/zh/functions/items/D495.md)
...
**注释 / Annotation**
n_lock(Ω) = Σᵢ step(C_exit(Ωᵢ) > θ_C(Ωᵢ))
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一函数总表/0493-D495-空间锁死维度计数函数.md`
