...
class CognitiveInheritanceR0Tests(unittest.TestCase):
    ...
    def test_change_allowlist_is_exact_outside_the_r0_artifact_subtree(self) -> None:
        ...
        self.assertTrue(is_allowed_changed_path("ignition/data/operations/iterations/185/research/internal-cognitive-archaeology-final-report.md"))
        self.assertTrue(is_allowed_changed_path("ignition/tests/foundation/test_function_asset_closure.py"))
        ...
        self.assertTrue(is_allowed_changed_path("ignition/tools/foundation/build_function_asset_census.py"))
        ...
        self.assertFalse(is_allowed_changed_path("ignition/data/operations/iterations/185/other/task.md"))
        self.assertFalse(is_allowed_changed_path("ignition/data/foundation/nonfunction-claims/claim-registry.jsonl"))
        self.assertFalse(is_allowed_changed_path("ignition/data/foundation/claims/claims.jsonl"))
