...
class CognitiveInheritanceR0Tests(unittest.TestCase):
    ...
    def test_change_allowlist_is_exact_outside_the_r0_artifact_subtree(self) -> None:
        ...
        self.assertFalse(is_allowed_changed_path("ignition/data/governance/self-correction/audit-findings.jsonl.bak"))
        self.assertFalse(is_allowed_changed_path("ignition/data/governance/self-correction/plan.json"))
        self.assertTrue(is_allowed_changed_path("ignition/tools/governance/gen_source_first_seen.py"))
        self.assertFalse(is_allowed_changed_path("ignition/tools/governance/gen_source_first_seen.py.bak"))
        ...
        self.assertTrue(is_allowed_changed_path("ignition/reports/external-research/IGNITION-20260918-186/external-cognitive-architecture-research-report.md"))
        self.assertFalse(is_allowed_changed_path("ignition/reports/external-research/IGNITION-20260918-187/external-cognitive-architecture-research-report.md"))
        self.assertTrue(is_allowed_changed_path("ignition/tests/foundation/fixtures/task186_research_surface_isolation.json"))
        self.assertTrue(is_allowed_changed_path("ignition/tests/foundation/test_claim_governance.py"))
        self.assertTrue(is_allowed_changed_path("ignition/tests/foundation/test_nonfunction_claim_closure.py"))
        self.assertTrue(is_allowed_changed_path("ignition/tools/foundation/adjudicate_nonfunction_claims.py"))
        self.assertTrue(is_allowed_changed_path("ignition/tools/research/validate_task186_external_research_bundle.py"))
        self.assertTrue(is_allowed_changed_path("ignition/data/governance/human-results/result-ledger.jsonl"))
        self.assertTrue(is_allowed_changed_path("ignition/KNOWLEDGE/ASSET-CARDS.md"))
        self.assertTrue(is_allowed_changed_path("ignition/KNOWLEDGE/cards/part-015.md"))
        self.assertTrue(is_allowed_changed_path("ignition/KNOWLEDGE/indexes/systems/part-006.md"))
        self.assertTrue(is_allowed_changed_path("ignition/KNOWLEDGE/reading-layers/part-013.md"))
        ...
        self.assertFalse(is_allowed_changed_path("ignition/KNOWLEDGE/NOTES.md"))
        self.assertFalse(is_allowed_changed_path("ignition/KNOWLEDGE/unrelated/part-001.md"))
