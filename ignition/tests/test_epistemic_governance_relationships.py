...
class Tests(unittest.TestCase):
 ...
 def test_readme_route_cannot_be_charter(self): self.bad(lambda d:next(r for r in d["public_surface_routes"] if r["path"]==".github/README.md").update({"authority":"charter.normative"}),"route tuple")
 def test_readme_registry_cannot_drift(self): self.bad(lambda d:next(r for r in d["public_surface_routes"] if r["path"]==".github/README.md").update({"registry":"data/architecture/interactive-system-map.json"}),"route tuple")
