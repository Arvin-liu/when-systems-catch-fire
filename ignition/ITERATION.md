...
- read `.github/README.md`, `STATE-CHANGELOG.md` baseline/recent deltas, `docs/project-current-state.md`, `AI-HANDOFF.md`, `AI-START-HERE.md`, `llms.txt`, `SUMMARY.md` and this file;
...
- if project form changed but `.github/README.md` / `docs/project-current-state.md` still project the superseded state, the iteration MUST NOT be judged `CLOSED`.
