...
source_line: 9048
link: "docs/zh/cases/items/C-0227.md"
---
...
**发现 / Discovery**
中文：对称-破缺-定向对偶——诺特定理的逆命题 English: Rule-based English rendering pending human rev…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：对称-破缺-定向对偶——诺特定理的逆命题 English: Rule-based English rendering pe… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0227-C-227-对称-破缺-定向对偶.md`
