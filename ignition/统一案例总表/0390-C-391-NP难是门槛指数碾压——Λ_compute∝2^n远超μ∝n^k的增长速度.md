...
id: "C-391"
raw_id: "#391"
title: "NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度 / NP难是门槛指数碾压 - - Λ_compute∝2^n远超μ∝n^k的增长速度"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 15562
link: "docs/zh/cases/items/C-0391.md"
---
...
**发现 / Discovery**
中文：NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度。核心函数：[D160](docs/zh/functions/items/D1…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度。核心函数：[D160](docs/zh/fun… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0390-C-391-NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度.md`
