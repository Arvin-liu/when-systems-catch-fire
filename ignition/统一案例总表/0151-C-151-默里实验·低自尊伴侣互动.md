...
source_line: 6033
link: "docs/zh/cases/items/C-0151.md"
---
...
**发现 / Discovery**
中文：默里实验·低自尊伴侣互动 → D57解读偏置函数验证 English: Rule-based English rendering pending hum…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：默里实验·低自尊伴侣互动 → D57解读偏置函数验证 English: Rule-based English render… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0151-C-151-默里实验·低自尊伴侣互动.md`
