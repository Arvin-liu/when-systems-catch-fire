...
id: "C-558"
raw_id: "#558"
title: "有性生殖 — 信息注入允许dΦ/dt<0，对抗Muller's ratchet / 有性生殖 - 信息注入允许dΦ/dt<0, 对抗Muller's ratchet"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 22165
link: "docs/zh/cases/items/C-0558.md"
---
...
**发现 / Discovery**
中文：有性生殖 — 信息注入允许dΦ/dt<0，对抗Muller's ratchet。核心函数：[D158](docs/zh/functions/items/…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：有性生殖 — 信息注入允许dΦ/dt<0，对抗Muller's ratchet。核心函数：[D158](docs/zh/f… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0553-C-558-有性生殖 — 信息注入允许dΦ.md`
