...
id: "C-543"
raw_id: "#543"
title: "量子霍尔效应 — 乘法门控离散象限→量子化，分数=复合粒子乘法门控"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21575
link: "docs/zh/cases/items/C-0543.md"
---
...
**发现 / Discovery**
中文：量子霍尔效应 — 乘法门控离散象限→量子化，分数=复合粒子乘法门控。核心函数：[D158](docs/zh/functions/items/D158.m…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：量子霍尔效应 — 乘法门控离散象限→量子化，分数=复合粒子乘法门控。核心函数：[D158](docs/zh/functio… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0538-C-543-量子霍尔效应 — 乘法门控离散象限→量子化,分数=复合粒子乘法门控.md`
