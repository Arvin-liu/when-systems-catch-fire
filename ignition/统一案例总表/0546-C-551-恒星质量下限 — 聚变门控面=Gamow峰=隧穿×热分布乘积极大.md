...
id: "C-551"
raw_id: "#551"
title: "恒星质量下限 — 聚变门控面=Gamow峰=隧穿×热分布乘积极大"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21892
link: "docs/zh/cases/items/C-0551.md"
---
...
**推测 / Hypothesis**
从这条案例看，中文：案例说明：恒星质量下限 — 聚变门控面=Gamow峰=隧穿×热分布乘积极大。核心函数：[D158](docs/zh/function… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0546-C-551-恒星质量下限 — 聚变门控面=Gamow峰=隧穿×热分布乘积极大.md`
