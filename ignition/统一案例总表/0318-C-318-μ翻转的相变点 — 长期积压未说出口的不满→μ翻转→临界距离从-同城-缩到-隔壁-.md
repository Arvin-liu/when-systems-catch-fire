...
id: "C-318"
raw_id: "#318"
title: "μ翻转的相变点 — 长期积压未说出口的不满→μ翻转→临界距离从\"同城\"缩到\"隔壁\""
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 12670
link: "docs/zh/cases/items/C-0318.md"
---
...
**发现 / Discovery**
中文：μ翻转的相变点 — 长期积压未说出口的不满→μ翻转→临界距离从"同城"缩到"隔壁"。核心函数：D78 English: Rule-based Engli…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：μ翻转的相变点 — 长期积压未说出口的不满→μ翻转→临界距离从"同城"缩到"隔壁"。核心函数：D78 English: R… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0318-C-318-μ翻转的相变点 — 长期积压未说出口的不满→μ翻转→临界距离从-同城-缩到-隔壁-.md`
