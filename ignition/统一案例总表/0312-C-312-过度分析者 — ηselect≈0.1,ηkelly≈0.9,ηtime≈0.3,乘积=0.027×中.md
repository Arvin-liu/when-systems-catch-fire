...
id: "C-312"
raw_id: "#312"
title: "过度分析者 — ηselect≈0.1，ηkelly≈0.9，ηtime≈0.3，乘积=0.027×中 / 过度分析者 - ηselect≈0.1, ηkelly≈0.9, ηtime≈0.3, 乘积=0.027 x 中"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 12435
link: "docs/zh/cases/items/C-0312.md"
---
...
**发现 / Discovery**
中文：过度分析者 — ηselect≈0.1，ηkelly≈0.9，ηtime≈0.3，乘积=0.027×中。核心函数：[D76](docs/zh/funct…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：过度分析者 — ηselect≈0.1，ηkelly≈0.9，ηtime≈0.3，乘积=0.027×中。核心函数：[D76… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0312-C-312-过度分析者 — ηselect≈0.1,ηkelly≈0.9,ηtime≈0.3,乘积=0.027×中.md`
