...
id: "C-423"
raw_id: "#423"
title: "智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 16832
link: "docs/zh/cases/items/C-0423.md"
---
...
**发现 / Discovery**
中文：智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消。核心函数：[D160](docs/zh/functions/items/D160.md) Engl…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消。核心函数：[D160](docs/zh/functions/item… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0422-C-423-智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消.md`
