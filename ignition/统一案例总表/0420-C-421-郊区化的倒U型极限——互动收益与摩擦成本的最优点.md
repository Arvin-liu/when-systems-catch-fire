...
id: "C-421"
raw_id: "#421"
title: "郊区化的倒U型极限——互动收益与摩擦成本的最优点"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 16754
link: "docs/zh/cases/items/C-0421.md"
---
...
**发现 / Discovery**
中文：郊区化的倒U型极限——互动收益与摩擦成本的最优点。核心函数：[D90](docs/zh/functions/items/D90.md) English:…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：郊区化的倒U型极限——互动收益与摩擦成本的最优点。核心函数：[D90](docs/zh/functions/items/D… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0420-C-421-郊区化的倒U型极限——互动收益与摩擦成本的最优点.md`
