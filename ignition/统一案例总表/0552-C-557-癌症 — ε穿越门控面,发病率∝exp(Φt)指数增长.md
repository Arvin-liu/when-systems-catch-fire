...
id: "C-557"
raw_id: "#557"
title: "癌症 — ε穿越门控面，发病率∝exp(Φt)指数增长"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 22126
link: "docs/zh/cases/items/C-0557.md"
---
...
**发现 / Discovery**
中文：癌症 — ε穿越门控面，发病率∝exp(Φt)指数增长。核心函数：[D158](docs/zh/functions/items/D158.md) Eng…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：癌症 — ε穿越门控面，发病率∝exp(Φt)指数增长。核心函数：[D158](docs/zh/functions/ite… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0552-C-557-癌症 — ε穿越门控面,发病率∝exp(Φt)指数增长.md`
