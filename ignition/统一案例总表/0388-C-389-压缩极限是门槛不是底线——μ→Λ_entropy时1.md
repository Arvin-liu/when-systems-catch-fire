...
id: "C-389"
raw_id: "#389"
title: "压缩极限是门槛不是底线——μ→Λ_entropy时1/ln→-∞，再压一点就崩 / 压缩极限是门槛不是底线 - - μ -> Λ_entropy时1/ln -> -∞, 再压一点就崩"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 15479
link: "docs/zh/cases/items/C-0389.md"
---
...
**发现 / Discovery**
中文：压缩极限是门槛不是底线——μ→Λ_entropy时1/ln→-∞，再压一点就崩。核心函数：[D159](docs/zh/functions/items/…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：压缩极限是门槛不是底线——μ→Λ_entropy时1/ln→-∞，再压一点就崩。核心函数：[D159](docs/zh/f… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0388-C-389-压缩极限是门槛不是底线——μ→Λ_entropy时1.md`
