...
id: "C-383"
raw_id: "#383"
title: "灭绝是加速崩塌——μ接近Λ时1/ln→-∞，最后几只个体存活贡献为负"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 15244
link: "docs/zh/cases/items/C-0383.md"
---
...
**发现 / Discovery**
中文：灭绝是加速崩塌——μ接近Λ时1/ln→-∞，最后几只个体存活贡献为负。核心函数：[D160](docs/zh/functions/items/D160.…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：灭绝是加速崩塌——μ接近Λ时1/ln→-∞，最后几只个体存活贡献为负。核心函数：[D160](docs/zh/functi… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0382-C-383-灭绝是加速崩塌——μ接近Λ时1.md`
