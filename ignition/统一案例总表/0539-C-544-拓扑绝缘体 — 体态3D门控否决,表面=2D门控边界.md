...
id: "C-544"
raw_id: "#544"
title: "拓扑绝缘体 — 体态3D门控否决，表面=2D门控边界"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21614
link: "docs/zh/cases/items/C-0544.md"
---
...
**发现 / Discovery**
中文：拓扑绝缘体 — 体态3D门控否决，表面=2D门控边界。核心函数：[D158](docs/zh/functions/items/D158.md) Engl…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：拓扑绝缘体 — 体态3D门控否决，表面=2D门控边界。核心函数：[D158](docs/zh/functions/item… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0539-C-544-拓扑绝缘体 — 体态3D门控否决,表面=2D门控边界.md`
