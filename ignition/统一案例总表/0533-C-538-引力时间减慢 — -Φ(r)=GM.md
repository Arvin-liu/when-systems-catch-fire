...
id: "C-538"
raw_id: "#538"
title: "引力时间减慢 — **Φ(r)=GM/(rc²)**=归一化引力势 / 引力时间减慢 - **Φ(r)=GM/(rc²)**=归一化引力势"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21375
link: "docs/zh/cases/items/C-0538.md"
---
...
**发现 / Discovery**
中文：引力时间减慢 — **Φ(r)=GM/(rc²)**=归一化引力势。核心函数：[D158](docs/zh/functions/items/D158.m…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：引力时间减慢 — **Φ(r)=GM/(rc²)**=归一化引力势。核心函数：[D158](docs/zh/functio… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0533-C-538-引力时间减慢 — -Φ(r)=GM.md`
