...
The metamorphic suite executed **808** checks across all six families: **0** model-quality violations, **67** explicitly not-applicable coverage checks, and **24** allowed safe-alternative changes. The suite includes exact repair, binding locality, irrelevant evidence, valid-signature/consequence, rollback/irreversibility, safe-authorized alternative and deadline properties.
