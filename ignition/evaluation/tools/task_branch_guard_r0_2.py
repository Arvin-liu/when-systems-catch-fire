#!/usr/bin/env python3
"""Task-scoped, fail-closed local branch guard for Evaluation Plane R0.2."""
...
AUTH_SCHEMA = IGNITION_ROOT / "evaluation" / "operational-control" / "r0.2" / "task-branch-authorization-r0.2.schema.json"
HOOKS_PATH = "ignition/evaluation/hooks"
