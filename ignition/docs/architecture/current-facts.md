...
- Knowledge Experience: cards `682`；changes `577`；layered readings `603`；search records `24743`；aliases `1411`。
- Fire Seeds: `64` seeds/clusters；`669` source-census records。
