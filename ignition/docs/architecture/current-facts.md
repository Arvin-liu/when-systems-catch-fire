...
- Knowledge Experience: cards `675`；changes `570`；layered readings `596`；search records `24734`；aliases `1397`。
- Fire Seeds: `64` seeds/clusters；`662` source-census records。
