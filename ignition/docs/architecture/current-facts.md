...
- Knowledge Experience: cards `656`；changes `551`；layered readings `577`；search records `24710`；aliases `1359`。
- Fire Seeds: `64` seeds/clusters；`642` source-census records。
