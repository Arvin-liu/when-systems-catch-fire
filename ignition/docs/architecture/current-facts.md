...
- Foundation: function identity cards `6041`；function quarantine/pending `4889`；non-function claims `17838`；non-function quarantine/pending `4992`。
- Knowledge Experience: cards `413`；changes `315`；layered readings `332`；search records `24211`；aliases `874`。
...
- Task lineage: current `IGNITION-20260829-148` `IN_PROGRESS`；125 file `HISTORICAL_UNEXECUTED`, requirements `REBASED_INTO_127`, canonical `HISTORICAL_UNEXECUTED_REBASED_INTO_127`；127 `COMPLETED_WITH_CLASSIFIED_RESIDUALS`。
- Formal task lifecycle: `IGNITION-20260829-148` `IN_PROGRESS` terminal `false` scope_complete `false`；source `ignition/data/operations/formal-task-lifecycle-r1.json`。
