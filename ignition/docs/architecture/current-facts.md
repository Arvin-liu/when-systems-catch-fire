...
- Knowledge Experience: cards `662`；changes `557`；layered readings `583`；search records `24716`；aliases `1371`。
- Fire Seeds: `64` seeds/clusters；`649` source-census records。
