...
- Knowledge Experience: cards `660`；changes `555`；layered readings `581`；search records `24714`；aliases `1367`。
- Fire Seeds: `64` seeds/clusters；`646` source-census records。
