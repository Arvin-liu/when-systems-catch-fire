...
- Foundation: function identity cards `6049`；function quarantine/pending `4897`；non-function claims `17868`；non-function quarantine/pending `5002`。
- Knowledge Experience: cards `602`；changes `495`；layered readings `521`；search records `24438`；aliases `1252`。
