...
- Knowledge Experience: cards `685`；changes `580`；layered readings `606`；search records `24746`；aliases `1417`。
- Fire Seeds: `64` seeds/clusters；`672` source-census records。
