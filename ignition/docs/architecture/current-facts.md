...
- Knowledge Experience: cards `673`；changes `568`；layered readings `594`；search records `24732`；aliases `1393`。
- Fire Seeds: `64` seeds/clusters；`660` source-census records。
