...
- Knowledge Experience: cards `661`；changes `556`；layered readings `582`；search records `24715`；aliases `1369`。
- Fire Seeds: `64` seeds/clusters；`647` source-census records。
