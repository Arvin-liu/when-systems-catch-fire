...
- Knowledge Experience: cards `672`；changes `567`；layered readings `593`；search records `24731`；aliases `1391`。
- Fire Seeds: `64` seeds/clusters；`659` source-census records。
