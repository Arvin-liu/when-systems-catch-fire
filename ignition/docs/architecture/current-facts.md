...
- Foundation: function identity cards `6157`；function quarantine/pending `5005`；non-function claims `17978`；non-function quarantine/pending `4993`。
- Knowledge Experience: cards `664`；changes `559`；layered readings `585`；search records `24720`；aliases `1375`。
- Fire Seeds: `64` seeds/clusters；`651` source-census records。
