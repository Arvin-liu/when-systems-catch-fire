...
- Foundation: function identity cards `6157`；function quarantine/pending `5005`；non-function claims `17979`；non-function quarantine/pending `4993`。
- Knowledge Experience: cards `665`；changes `560`；layered readings `586`；search records `24722`；aliases `1377`。
- Fire Seeds: `64` seeds/clusters；`652` source-census records。
