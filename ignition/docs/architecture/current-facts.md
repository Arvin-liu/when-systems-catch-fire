...
- Iteration identity: current formal task `IGNITION-20260823-136` (ordinal `136`)；latest architecture-changing task `IGNITION-20260823-136` (ordinal `136`)；`current_iteration_boundary` `136` is a deprecated compatibility alias of the formal ordinal。
...
- Foundation: function identity cards `5624`；function quarantine/pending `4825`；non-function claims `16570`；non-function quarantine/pending `4727`。
- Knowledge Experience: cards `413`；changes `315`；layered readings `332`；search records `22526`；aliases `875`。
