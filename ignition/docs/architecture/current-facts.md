...
- Knowledge Experience: cards `676`；changes `571`；layered readings `597`；search records `24735`；aliases `1399`。
- Fire Seeds: `64` seeds/clusters；`663` source-census records。
