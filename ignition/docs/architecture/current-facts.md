...
- Knowledge Experience: cards `663`；changes `558`；layered readings `584`；search records `24719`；aliases `1373`。
- Fire Seeds: `64` seeds/clusters；`650` source-census records。
