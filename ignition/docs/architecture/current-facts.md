...
- Knowledge Experience: cards `668`；changes `563`；layered readings `589`；search records `24727`；aliases `1383`。
- Fire Seeds: `64` seeds/clusters；`655` source-census records。
