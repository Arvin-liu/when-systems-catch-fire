...
- Knowledge Experience: cards `681`；changes `576`；layered readings `602`；search records `24742`；aliases `1409`。
- Fire Seeds: `64` seeds/clusters；`668` source-census records。
