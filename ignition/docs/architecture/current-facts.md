...
- Knowledge Experience: cards `684`；changes `579`；layered readings `605`；search records `24745`；aliases `1415`。
- Fire Seeds: `64` seeds/clusters；`671` source-census records。
