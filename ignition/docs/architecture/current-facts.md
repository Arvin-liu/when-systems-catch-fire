...
- Foundation: function identity cards `6157`；function quarantine/pending `5005`；non-function claims `17981`；non-function quarantine/pending `4993`。
- Knowledge Experience: cards `674`；changes `569`；layered readings `595`；search records `24733`；aliases `1395`。
- Fire Seeds: `64` seeds/clusters；`661` source-census records。
