...
- Knowledge Experience: cards `670`；changes `565`；layered readings `591`；search records `24729`；aliases `1387`。
- Fire Seeds: `64` seeds/clusters；`657` source-census records。
