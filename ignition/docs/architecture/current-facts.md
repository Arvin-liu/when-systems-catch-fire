...
- Identity epoch: `os-control-plane-r3-durability-lifecycle-r0`；current iteration boundary: `127`。
...
- Foundation: function identity cards `5611`；function quarantine/pending `4812`；non-function claims `16209`；non-function quarantine/pending `4683`。
- Knowledge Experience: cards `403`；changes `315`；layered readings `332`；search records `22152`；aliases `851`。
