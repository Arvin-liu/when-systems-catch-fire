...
- Foundation: function identity cards `6158`；function quarantine/pending `5006`；non-function claims `18003`；non-function quarantine/pending `4996`。
- Knowledge Experience: cards `691`；changes `586`；layered readings `612`；search records `24773`；aliases `1429`。
- Fire Seeds: `64` seeds/clusters；`678` source-census records。
