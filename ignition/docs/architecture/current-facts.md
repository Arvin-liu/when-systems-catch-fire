...
- Knowledge Experience: cards `666`；changes `561`；layered readings `587`；search records `24724`；aliases `1379`。
- Fire Seeds: `64` seeds/clusters；`653` source-census records。
