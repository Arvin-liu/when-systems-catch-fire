...
- Knowledge Experience: cards `679`；changes `574`；layered readings `600`；search records `24740`；aliases `1405`。
- Fire Seeds: `64` seeds/clusters；`666` source-census records。
