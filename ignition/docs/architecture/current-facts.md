...
- Foundation: function identity cards `6042`；function quarantine/pending `4890`；non-function claims `17859`；non-function quarantine/pending `4996`。
- Knowledge Experience: cards `602`；changes `495`；layered readings `521`；search records `24422`；aliases `1252`。
