...
- Foundation: function identity cards `6157`；function quarantine/pending `5005`；non-function claims `17976`；non-function quarantine/pending `4993`。
- Knowledge Experience: cards `659`；changes `554`；layered readings `580`；search records `24713`；aliases `1365`。
- Fire Seeds: `64` seeds/clusters；`645` source-census records。
