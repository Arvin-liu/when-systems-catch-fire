...
- Knowledge Experience: cards `680`；changes `575`；layered readings `601`；search records `24741`；aliases `1407`。
- Fire Seeds: `64` seeds/clusters；`667` source-census records。
