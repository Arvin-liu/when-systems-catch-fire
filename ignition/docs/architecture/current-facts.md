...
- Foundation: function identity cards `6026`；function quarantine/pending `4874`；non-function claims `17473`；non-function quarantine/pending `4940`。
- Knowledge Experience: cards `414`；changes `315`；layered readings `332`；search records `23831`；aliases `876`。
