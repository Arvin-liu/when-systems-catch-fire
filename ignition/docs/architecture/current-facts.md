...
- Knowledge Experience: cards `678`；changes `573`；layered readings `599`；search records `24739`；aliases `1403`。
- Fire Seeds: `64` seeds/clusters；`665` source-census records。
