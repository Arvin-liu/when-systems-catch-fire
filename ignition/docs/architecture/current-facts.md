...
- Knowledge Experience: cards `658`；changes `553`；layered readings `579`；search records `24712`；aliases `1363`。
- Fire Seeds: `64` seeds/clusters；`644` source-census records。
