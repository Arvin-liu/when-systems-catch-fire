...
- Iteration identity: current formal task `IGNITION-20260824-137` (ordinal `137`)；latest architecture-changing task `IGNITION-20260823-136` (ordinal `136`)；`current_iteration_boundary` `137` is a deprecated compatibility alias of the formal ordinal。
...
- Foundation: function identity cards `5788`；function quarantine/pending `4842`；non-function claims `16742`；non-function quarantine/pending `4797`。
- Knowledge Experience: cards `413`；changes `315`；layered readings `332`；search records `22862`；aliases `875`。
...
- Task lineage: current `IGNITION-20260824-137` `COMPLETED_WITH_CLASSIFIED_RESIDUALS`；125 file `HISTORICAL_UNEXECUTED`, requirements `REBASED_INTO_127`, canonical `HISTORICAL_UNEXECUTED_REBASED_INTO_127`；127 `COMPLETED_WITH_CLASSIFIED_RESIDUALS`。
