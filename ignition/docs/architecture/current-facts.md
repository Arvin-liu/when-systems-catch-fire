...
- Knowledge Experience: cards `677`；changes `572`；layered readings `598`；search records `24736`；aliases `1401`。
- Fire Seeds: `64` seeds/clusters；`664` source-census records。
