...
- Knowledge Experience: cards `655`；changes `550`；layered readings `576`；search records `24705`；aliases `1357`。
- Fire Seeds: `64` seeds/clusters；`641` source-census records。
