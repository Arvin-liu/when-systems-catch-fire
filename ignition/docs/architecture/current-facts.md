...
- Iteration identity: current formal task `IGNITION-20260824-138` (ordinal `138`)；latest architecture-changing task `IGNITION-20260823-136` (ordinal `136`)；`current_iteration_boundary` `138` is a deprecated compatibility alias of the formal ordinal。
...
- Foundation: function identity cards `5858`；function quarantine/pending `4854`；non-function claims `16855`；non-function quarantine/pending `4812`。
- Knowledge Experience: cards `414`；changes `315`；layered readings `332`；search records `23045`；aliases `877`。
...
- Task lineage: current `IGNITION-20260824-138` `IN_PROGRESS`；125 file `HISTORICAL_UNEXECUTED`, requirements `REBASED_INTO_127`, canonical `HISTORICAL_UNEXECUTED_REBASED_INTO_127`；127 `COMPLETED_WITH_CLASSIFIED_RESIDUALS`。
