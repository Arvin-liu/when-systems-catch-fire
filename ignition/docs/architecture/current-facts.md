...
- Knowledge Experience: cards `671`；changes `566`；layered readings `592`；search records `24730`；aliases `1389`。
- Fire Seeds: `64` seeds/clusters；`658` source-census records。
