...
- Knowledge Experience: cards `669`；changes `564`；layered readings `590`；search records `24728`；aliases `1385`。
- Fire Seeds: `64` seeds/clusters；`656` source-census records。
