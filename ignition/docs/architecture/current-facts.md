...
- Knowledge Experience: cards `657`；changes `552`；layered readings `578`；search records `24711`；aliases `1361`。
- Fire Seeds: `64` seeds/clusters；`643` source-census records。
