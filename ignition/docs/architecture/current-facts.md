...
- Knowledge Experience: cards `686`；changes `581`；layered readings `607`；search records `24747`；aliases `1419`。
- Fire Seeds: `64` seeds/clusters；`673` source-census records。
