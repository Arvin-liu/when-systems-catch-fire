...
- Iteration identity: current formal task `IGNITION-20260828-146` (ordinal `146`)；latest architecture-changing task `IGNITION-20260827-142` (ordinal `142`)；`current_iteration_boundary` `146` is a deprecated compatibility alias of the formal ordinal。
