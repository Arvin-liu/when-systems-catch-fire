...
- Foundation: function identity cards `6157`；function quarantine/pending `5005`；non-function claims `17980`；non-function quarantine/pending `4993`。
- Knowledge Experience: cards `667`；changes `562`；layered readings `588`；search records `24725`；aliases `1381`。
- Fire Seeds: `64` seeds/clusters；`654` source-census records。
