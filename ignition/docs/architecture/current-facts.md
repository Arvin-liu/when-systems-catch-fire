...
- Foundation: function identity cards `6030`；function quarantine/pending `4878`；non-function claims `17623`；non-function quarantine/pending `4942`。
- Knowledge Experience: cards `413`；changes `315`；layered readings `332`；search records `23985`；aliases `874`。
