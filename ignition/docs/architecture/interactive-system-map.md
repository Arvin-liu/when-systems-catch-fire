...
状态：`0.12.0 Current registry-derived navigation projection`；`0.11.0`、`0.10.0`、`0.9.0`、`0.8.0`、`0.7.0`、`0.6.0`、`0.5.0`、`0.4.0` 与更早版本为 Historical。
...
`current-facts.json` 为准；当前地图为 `0.12.0`，上一版 `0.11.0`、更早版 `0.10.0` 仅作 Historical。
