...
- [epistemic_state: `CURRENT_WITH_OPEN_OBLIGATIONS` and `EPISTEMICALLY_ACCEPTED=0` remain unchanged. Historical Task125 rem](../../../STATE-CHANGELOG.md)
  ...
  - 来源：`STATE-CHANGELOG.md`
  - 依赖：—；被引用：—
- [epistemic_state: `CURRENT_WITH_OPEN_OBLIGATIONS` and `EPISTEMICALLY_ACCEPTED=0` remain unchanged. Provider observations](../../../STATE-CHANGELOG.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-b3c5c7948b976bda / epistemic_state: `CURRENT_WITH_OPEN_OBLIGATIONS` and `EPISTEMICALLY_ACCEPTED=0` remain unchanged. Provider observations
  - 来源：`STATE-CHANGELOG.md`
  - 依赖：—；被引用：—
