...
- [the artifact and version reviewed;](../../../docs/participate.md)
  ...
  - 来源：`docs/participate.md`
  - 依赖：—；被引用：—
- [The audit does not falsify the existing Charter, Claim Governance, Kernel, OS Steering, Approval, Runtime, Stage Snapsho](../../../reports/governance/task-IGNITION-20260904-154.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-e35a88160972ef2d / The audit does not falsify the existing Charter, Claim Governance, Kernel, OS Steering, Approval, Runtime, Stage Snapsho
...
- [The candidate closure gate exposed a deterministic projection mismatch after Step15: existing Foundation, deep-adjudicat](../../../reports/operations/ignition-144-step16-repair-cycle-b.md)
  ...
  - 依赖：—；被引用：—
- [The candidate validation record is deliberately claim-bounded. Generated projections were rebuilt only through their rep](../../../reports/governance/task-IGNITION-20260904-154.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-bc9298cd1414fe3d / The candidate validation record is deliberately claim-bounded. Generated projections were rebuilt only through their rep
  - 来源：`reports/governance/task-IGNITION-20260904-154.md`
  - 依赖：—；被引用：—
...
- [the evidence used;](../../../docs/participate.md)
  ...
  - 来源：`docs/participate.md`
  - 依赖：—；被引用：—
- [The exact final candidate commit SHA is intentionally not embedded in this tracked report: the repository's iteration co](../../../reports/governance/task-IGNITION-20260904-153.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-4ff3a1848b77821b / The exact final candidate commit SHA is intentionally not embedded in this tracked report: the repository's iteration co
...
- [The first real LIGHT pilot compared a blinded ordinary-research baseline with REOS_LIGHT on the same adult factual-item](../../../docs/architecture/reos-vnext-light.md)
  ...
  - 来源：`docs/architecture/reos-vnext-light.md`
  - 依赖：—；被引用：—
- [The following is the final local validation record for the candidate source and its deterministic projections. Commands](../../../reports/governance/task-IGNITION-20260904-153.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-d153877e50fd984d / The following is the final local validation record for the candidate source and its deterministic projections. Commands
  - 来源：`reports/governance/task-IGNITION-20260904-153.md`
  - 依赖：—；被引用：—
- [The following run then exposed three Current Facts failures. The regenerated](../../../reports/operations/ignition-138-step13-targeted-regression.md)
  ...
  - 来源：`reports/operations/ignition-138-step13-targeted-regression.md`
  - 依赖：—；被引用：—
- [The Foundation unit-test failure is retained as an environmental/test-timing residual, not relabelled as a pass. The fir](../../../reports/governance/task-IGNITION-20260904-153.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-f60f46275e81b8d5 / The Foundation unit-test failure is retained as an environmental/test-timing residual, not relabelled as a pass. The fir
  - 来源：`reports/governance/task-IGNITION-20260904-153.md`
  - 依赖：—；被引用：—
...
- [The request asks the validator to decide truth, quality, acceptance or deployment.](../../../docs/operations/ignition-operation-playbooks-r1.md)
  ...
  - 来源：`docs/operations/ignition-operation-playbooks-r1.md`
  - 依赖：—；被引用：—
- [the requested 13 axes: `observe`, `transform evidence`, `infer`, `propose`, `evaluate`, `approve`, `authorize`, `execute](../../../reports/governance/task-IGNITION-20260904-153.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-c3071754b169c3e9 / the requested 13 axes: `observe`, `transform evidence`, `infer`, `propose`, `evaluate`, `approve`, `authorize`, `execute
  - 来源：`reports/governance/task-IGNITION-20260904-153.md`
  - 依赖：—；被引用：—
- [the required authority/evidence, budget/Charter, contest/rollback and provenance/signer coupling countermodels;](../../../reports/governance/task-IGNITION-20260904-154.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-8eedb68d923135a0 / the required authority/evidence, budget/Charter, contest/rollback and provenance/signer coupling countermodels;
  - 来源：`reports/governance/task-IGNITION-20260904-154.md`
  - 依赖：—；被引用：—
- [The required Current refresh includes `ignition/data/architecture/current-facts.json`, `ignition/docs/architecture/curre](../../../reports/governance/task-IGNITION-20260904-153.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-3521198823777f41 / The required Current refresh includes `ignition/data/architecture/current-facts.json`, `ignition/docs/architecture/curre
  - 来源：`reports/governance/task-IGNITION-20260904-153.md`
  - 依赖：—；被引用：—
...
- [These checks establish repository synchronization only, not substantive truth.](../../../ITERATION.md)
  ...
  - 来源：`ITERATION.md`
  - 依赖：—；被引用：—
- [These results establish only reproducible repository-local research and projection integrity. They do not establish exte](../../../reports/governance/task-IGNITION-20260904-154.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-39ff93d4ae1a1a2a / These results establish only reproducible repository-local research and projection integrity. They do not establish exte
  - 来源：`reports/governance/task-IGNITION-20260904-154.md`
  - 依赖：—；被引用：—
