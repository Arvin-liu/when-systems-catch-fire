...
- [第 002 片](./architecture_governance/part-002.md)：501—1000；`1111` witness evidence are separate gates. → Crossref 验证状态
- [第 003 片](./architecture_governance/part-003.md)：1001—1500；CSV、TSV、JSON 等表格数据 → def append\(
