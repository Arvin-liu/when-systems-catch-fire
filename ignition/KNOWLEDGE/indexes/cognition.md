...
- [第 002 片](./cognition/part-002.md)：501—1000；if not isinstance\(projection, MemoryProjection\): → \| \[C-481\]\( \) \| \[认知叠加验证 — 专家vs通才：专
- [第 003 片](./cognition/part-003.md)：1001—1232；\| \[C-486\]\( \) \| \[路径积分验证 — 创业决策：ℏ_e → 高维认知必然多轨，dim>1 ⟹ P_track>1。
