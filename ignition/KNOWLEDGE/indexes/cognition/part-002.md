...
- [Governance report: IGNITION-20260907-163](../../ASSET-CARDS.md#asset-hr-f9cf8e83465264a9)
  ...
  - 依赖：—；被引用：—
- [H1: PR #218 remains `OPEN` + `DRAFT` + unmerged. Its body will be synchronized to the final exact head and final Step/Ga](../../../agent-results/IGNITION-20260915-178-result.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-740aa290eb882880 / H1: PR #218 remains `OPEN` + `DRAFT` + unmerged. Its body will be synchronized to the final exact head and final Step/Ga
...
- [The writer owns an attempt-specific raw spool. ``LiveCaptureCapsule`` never](../../../agent_federation/live_capture.py)
  ...
  - 来源：`agent_federation/live_capture.py`
  - 依赖：—；被引用：—
- [They were regenerated by the official generator, not hand-edited. The resulting checks passed: Human Results `records=61](../../../agent-results/IGNITION-20260915-178-result.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-441a834fc57a9ba0 / They were regenerated by the official generator, not hand-edited. The resulting checks passed: Human Results `records=61
  - 来源：`agent-results/IGNITION-20260915-178-result.md`
  - 依赖：—；被引用：—
