...
- [本协议不修改 Ψ₀ 数学定义，不修改历史函数来源，不新增 D/MF/T/A 编号。](../../../templates/protocol-entry-template.md)
  ...
  - 依赖：—；被引用：—
- [本图不是 AI consciousness / personhood / moral status / legal responsibility 结论；](../../../docs/governance/accountable-cognition-boundary-map-2026-09-04.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-12d4f70d9879b209 / 本图不是 AI consciousness / personhood / moral status / legal responsibility 结论；
  - 来源：`docs/governance/accountable-cognition-boundary-map-2026-09-04.md`
  - 依赖：—；被引用：—
- [本图不证明 Human Owner 已经理解全部 Agent reasoning 或现实后果；](../../../docs/governance/accountable-cognition-boundary-map-2026-09-04.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-9c324faf940e5236 / 本图不证明 Human Owner 已经理解全部 Agent reasoning 或现实后果；
  - 来源：`docs/governance/accountable-cognition-boundary-map-2026-09-04.md`
  - 依赖：—；被引用：—
- [本图不证明当前所有角色分离在现实系统中已经执行；它只整理仓库合同与暴露的残余；](../../../docs/governance/accountable-cognition-boundary-map-2026-09-04.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-307a88a31647f00a / 本图不证明当前所有角色分离在现实系统中已经执行；它只整理仓库合同与暴露的残余；
  - 来源：`docs/governance/accountable-cognition-boundary-map-2026-09-04.md`
  - 依赖：—；被引用：—
...
- [本轮把成果展示实现为 L6 内部的可追溯仓库接口，而不是手工链接表或新架构层。README 只保留一套常态项目现状，并按“项目现状 → 之元写作法成果 → 生命共同体价值宪章 → 使用指南”组织；详细能力和完整 AI 提示词均默认折叠。](../../../reports/operations/121Q30-homepage-architecture-and-zhiyuan-writing-showcase-audit.md)
  ...
  - 依赖：—；被引用：—
- [本轮没有引入外部文献、外部事实或现实案例数据。因而下文不能证明六类在仓库外普遍必要，也不能证明任何价值命题、因果命题或协议有效性。](../../../docs/governance/value-epistemology-derivation-audit-2026-09-04.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-9b6ecfb1e0288884 / 本轮没有引入外部文献、外部事实或现实案例数据。因而下文不能证明六类在仓库外普遍必要，也不能证明任何价值命题、因果命题或协议有效性。
