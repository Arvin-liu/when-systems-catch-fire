...
- [The published proof is not valid as printed: Eq. 39-40 sums only over k≠t while trying to include the k=t term, and writ](../../../data/external-research/121-fulltext-resolver/121cx/121cx-extreme-semantic-evidence-cards.jsonl)
  ...
  - 来源：`data/external-research/121-fulltext-resolver/121cx/121cx-extreme-semantic-evidence-cards.jsonl`
  - 依赖：—；被引用：—
- [The R2/Federation lifecycle still requires final main and fresh-clone exact verification.](../../../llms.txt)
  - 类型/状态：`NONFUNCTION_CLAIM` · `RETAINED_AS_RESEARCH_HYPOTHESIS`
  - 可搜索名称：NFC-24d31ba41e373338 / The R2/Federation lifecycle still requires final main and fresh-clone exact verification.
  - 来源：`llms.txt`
  - 依赖：—；被引用：—
