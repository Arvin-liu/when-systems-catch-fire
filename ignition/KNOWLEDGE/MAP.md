...
当前检索覆盖 18616 项，重点卡片 313 项。 [打开本主题完整索引](./indexes/architecture_governance.md)
...
当前检索覆盖 12565 项，重点卡片 446 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 428 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
