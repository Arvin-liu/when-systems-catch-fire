...
当前检索覆盖 9740 项，重点卡片 154 项。 [打开本主题完整索引](./indexes/mathematics.md)
...
- 其余 136 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `MATHEMATICS`。
...
当前检索覆盖 12577 项，重点卡片 452 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 434 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
