...
当前检索覆盖 9539 项，重点卡片 102 项。 [打开本主题完整索引](./indexes/mathematics.md)
...
当前检索覆盖 4104 项，重点卡片 85 项。 [打开本主题完整索引](./indexes/systems.md)
...
当前检索覆盖 2335 项，重点卡片 46 项。 [打开本主题完整索引](./indexes/cognition.md)
...
当前检索覆盖 17582 项，重点卡片 219 项。 [打开本主题完整索引](./indexes/architecture_governance.md)
...
当前检索覆盖 1189 项，重点卡片 64 项。 [打开本主题完整索引](./indexes/writing_publication.md)
...
当前检索覆盖 11614 项，重点卡片 264 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 246 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
