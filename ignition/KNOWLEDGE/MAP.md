...
当前检索覆盖 9741 项，重点卡片 155 项。 [打开本主题完整索引](./indexes/mathematics.md)
...
- 其余 137 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `MATHEMATICS`。
...
当前检索覆盖 12578 项，重点卡片 453 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 435 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
