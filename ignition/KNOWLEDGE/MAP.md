...
当前检索覆盖 9739 项，重点卡片 153 项。 [打开本主题完整索引](./indexes/mathematics.md)
...
- 其余 135 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `MATHEMATICS`。
...
当前检索覆盖 12576 项，重点卡片 451 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 433 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
