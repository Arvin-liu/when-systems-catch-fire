...
当前检索覆盖 18619 项，重点卡片 313 项。 [打开本主题完整索引](./indexes/architecture_governance.md)
...
当前检索覆盖 12573 项，重点卡片 448 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 430 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
