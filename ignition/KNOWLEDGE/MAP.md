...
当前检索覆盖 9416 项，重点卡片 102 项。 [打开本主题完整索引](./indexes/mathematics.md)
...
当前检索覆盖 2046 项，重点卡片 46 项。 [打开本主题完整索引](./indexes/cognition.md)
...
当前检索覆盖 16721 项，重点卡片 219 项。 [打开本主题完整索引](./indexes/architecture_governance.md)
...
当前检索覆盖 1137 项，重点卡片 64 项。 [打开本主题完整索引](./indexes/writing_publication.md)
...
- 其余 235 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
