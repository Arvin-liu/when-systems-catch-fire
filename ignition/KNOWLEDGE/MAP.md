...
当前检索覆盖 9742 项，重点卡片 156 项。 [打开本主题完整索引](./indexes/mathematics.md)
...
- 其余 138 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `MATHEMATICS`。
...
当前检索覆盖 18621 项，重点卡片 315 项。 [打开本主题完整索引](./indexes/architecture_governance.md)
...
当前检索覆盖 12579 项，重点卡片 454 项。 [打开本主题完整索引](./indexes/operations_evidence.md)
...
- 其余 436 张重点卡片可在[资产卡总表](./ASSET-CARDS.md)搜索主题标记 `OPERATIONS_EVIDENCE`。
