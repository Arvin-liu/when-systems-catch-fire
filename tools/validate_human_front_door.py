...
VERSION_FACTS = {
    ...
    "current_map": "0.5.0",
    "historical_map": "0.4.0",
    "earlier_historical_map": "0.3.0",
}
...
def validate_texts(readme: str, guide: str, current_state: str, human_reading: str) -> None:
    required_order = ["## 当前结论", "## 已完成的纠正", "## 仍然开放的问题", "## 研究、复算与文章结果", "## 函数与断言裁决结果", "## 持续自我纠错", "## 系统图", "## 项目内容入口"]
    ...
    require("大一统普遍不可能" in readme and ("没有证明" in readme or "撤回" in readme), "README omits bounded physics correction")
