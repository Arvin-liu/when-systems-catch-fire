...
def build(check=False):
    ...
    project={
      "snapshot_id":"IGNITION-20260729-099",
      "status":"FUNCTION_ASSET_REGISTRY_CLOSED_WITH_EXPLICIT_QUARANTINE",
      "base_076_head":"fc3f2ae309ad3dd485716ab5675948a6a46cd75d",
      "counts":counts,
      "migration_coverage":"complete",
      "semantic_adjudication":"registry_closed_by_identity_or_explicit_quarantine; content proofs and empirical obligations remain independently open",
