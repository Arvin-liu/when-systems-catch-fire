...
def build(check=False):
    ...
    project={
      "snapshot_id":"IGNITION-20260729-098",
      "status":"CORE_KERNEL_PLUS_CLAIM_GOVERNANCE_FIRST_CORRECTIONS_REMAINING_CONTENT_QUEUE",
      "base_076_head":"fc3f2ae309ad3dd485716ab5675948a6a46cd75d",
      "counts":counts,
      "migration_coverage":"complete",
      "semantic_adjudication":"incomplete",
