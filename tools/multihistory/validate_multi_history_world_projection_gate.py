...
from tools.governance.r3_capability_evaluators import evaluate_multi_history_world_projection, get_matrix
CONFIG=json.loads("{\"task_id\": \"D2-I1\", \"capability\": \"multi_history_world_projection\", \"parent_id\": \"F15-D1-I1\", \"parent_head\": \"95405ae791dc0359c2ab6597bfd7c50224c2c59c\", \"fields\": [\"world_candidates\", \"divergence_point\", \"shared_evidence\", \"branch_specific_assumptions\", \"indistinguishable_set\", \"falsifiers\", \"justified_weights\", \"unresolved_paths\", \"narrative_ceiling\", \"claim_ceiling\"], \"rules\": [\"every_world_evidence_bound\", \"no_forced_unique_story\", \"indistinguishable_not_ranked_fact\", \"weights_need_justification\", \"possibility_not_probability\", \"falsifier_required\", \"unresolved_paths_preserved\", \"narrative_ceiling_preserved\"], \"schema\": \"schemas/multihistory/multi_history_world_projection-contract.schema.json\", \"forbidden_claims\": [\"generated possibility is not real probability\", \"indistinguishable paths are not ranked facts\", \"no evidence-free story\", \"no forced unique narrative\", \"universal truth\", \"causal proof established\", \"ecosystem deployed\"]}")
CONFIG["evaluator"] = evaluate_multi_history_world_projection
CONFIG["evidence_matrix"] = get_matrix("multi_history_world_projection")
