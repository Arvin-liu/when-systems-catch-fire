...
#### IGNITION-R5A-CONSOLIDATED-CANDIDATE-EXACT-HEAD-REVIEW-R1 (rejected; one narrow repair required)

The complete PR #130 candidate was independently reviewed at exact head `f33be64b26ef14d14098f42ec947bd93fddd245c` against base `f236543dadcaf79ba9dba750fa21bd8b5c65a33a`. Its 177 focused tests, exact 30-case gate, 595+2 inherited ARR suite, Foundation/Lean/synchronization/propagation/system-map/front-door/static checks, deterministic generation and three exact-head Actions runs were green, but those checks did not cover every public construction and schema-validation path. Eleven stable synthetic instances (`R5A-CR-001`–`R5A-CR-011`) reproduced forbidden direct translation construction, incomplete translation objects, cross-boundary provenance, untyped relations, structured-field treatment-stop language, safety type confusion, non-distinct longitudinal times, invalid concept current state, and three generated-schema fail-open paths. The terminal repository-contract decision is `R5A_CONSOLIDATED_EXACT_HEAD_REJECTED_NARROW_REPAIR_REQUIRED`; details and the one allowed repair scope are recorded in `docs/governance/r5a-consolidated-exact-head-review-r1.md`. PR #130 was not moved to Ready and was not merged into its predecessor. This is not Main, Current, activation, a human-safety finding, or authorization for R5-B/R5-C/R6.
