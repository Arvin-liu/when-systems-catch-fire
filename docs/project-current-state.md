...
PR #134 remains OPEN/DRAFT after its exact head `5a856c031616ec0a959150baebb7edced34f22bc` was rejected for the A15c/A15d responsibility-actor false accepts. An isolated narrow repair adds structured `PERSON`/`ORGANIZATION` accountability and separates execution agents/workflows from final responsibility; it does not re-review PR #134, alter Main, or make method 1.4.0 Current.
