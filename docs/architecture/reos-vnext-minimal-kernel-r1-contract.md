...
case.question_contract           # preregistration ref + minimal frozen summary
case.owner_boundary
...
3. Question amendments append `{from_digest, to_digest, reason, version}`; silent replacement is invalid.
