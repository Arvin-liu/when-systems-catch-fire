...
状态：`0.4.0 Current registry-derived navigation projection`；`0.3.0`、`0.2.0` 为 Historical。
...
`project component registry + typed propagation topology + layout overlay → deterministic generator → materialized spec + repository SVG → README / ordinary Markdown navigation`
