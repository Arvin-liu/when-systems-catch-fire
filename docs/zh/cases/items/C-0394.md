# [C-0394](C-0394.md)｜缓存是降低门槛——降低Λ_compute让更多μ过门槛，[D162](../../functions/items/D162.md)的逆操作
...
中文：
案例说明：缓存是降低门槛——降低Λ_compute让更多μ过门槛，[D162](../../functions/items/D162.md)的逆操作。核心函数：[D162](../../functions/items/D162.md)
...
中文：
缓存是降低门槛——降低Λ_compute让更多μ过门槛，[D162](../../functions/items/D162.md)的逆操作。核心函数：[D162](../../functions/items/D162.md)
