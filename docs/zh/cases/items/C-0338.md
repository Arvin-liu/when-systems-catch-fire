# [C-0338](C-0338.md)｜[D149](../../functions/items/D149.md)深层含义 — 巴菲特模式真正优势不是判断准，是结构让判断不必要
...
中文：
案例说明：[D149](../../functions/items/D149.md)深层含义 — 巴菲特模式真正优势不是判断准，是结构让判断不必要。核心函数：[D89](../../functions/items/D89.md)
...
中文：
[D149](../../functions/items/D149.md)深层含义 — 巴菲特模式真正优势不是判断准，是结构让判断不必要。核心函数：[D89](../../functions/items/D89.md)
