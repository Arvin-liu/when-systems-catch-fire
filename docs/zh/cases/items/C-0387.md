# [C-0387](C-0387.md)｜病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态
...
中文：
案例说明：病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态。核心函数：[D167](../../functions/items/D167.md)
...
中文：
病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态。核心函数：[D167](../../functions/items/D167.md)
