# [C-0307](C-0307.md)｜四阶段严格串行验证 — 不能跳过Stage2直接到Stage3：rcross=0时[D84](../../functions/items/D84.md)三条路径失效 / 四阶段严格串行验证 - 不能跳过Stage2直接到Stage3: rcross=0时[D84](../../functions/items/D84.md)三条路径失效
...
中文：
案例说明：四阶段严格串行验证 — 不能跳过Stage2直接到Stage3：rcross=0时[D84](../../functions/items/D84.md)三条路径失效。核心函数：[D74](../../functions/items/D74.md)
...
中文：
四阶段严格串行验证 — 不能跳过Stage2直接到Stage3：rcross=0时[D84](../../functions/items/D84.md)三条路径失效。核心函数：[D74](../../functions/items/D74.md)
