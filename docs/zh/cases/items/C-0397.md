# [C-0397](C-0397.md)｜创伤的双重碾压+向下兼容——μ↓+Λ↑双重门槛碾压+回避的保真度损失
...
中文：
案例说明：创伤的双重碾压+向下兼容——μ↓+Λ↑双重门槛碾压+回避的保真度损失。核心函数：[D160](../../functions/items/D160.md)×[D92](../../functions/items/D92.md)
...
中文：
创伤的双重碾压+向下兼容——μ↓+Λ↑双重门槛碾压+回避的保真度损失。核心函数：[D160](../../functions/items/D160.md)×[D92](../../functions/items/D92.md)
