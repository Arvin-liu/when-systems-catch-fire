# [C-0168](C-0168.md)｜H_total放大触发F_collapse（验证[D65](../../functions/items/D65.md)） / H_total放大触发F_collapse(验证[D65](../../functions/items/D65.md))
...
中文：
案例说明：H_total放大触发F_collapse（验证[D65](../../functions/items/D65.md)）
...
中文：
H_total放大触发F_collapse（验证[D65](../../functions/items/D65.md)）
