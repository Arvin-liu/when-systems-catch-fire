# [C-0165](C-0165.md)｜炒股带宽溢出全领域衰减（验证[D63](../../functions/items/D63.md)跨域溢出）
...
中文：
案例说明：炒股带宽溢出全领域衰减（验证[D63](../../functions/items/D63.md)跨域溢出）
...
中文：
炒股带宽溢出全领域衰减（验证[D63](../../functions/items/D63.md)跨域溢出）
