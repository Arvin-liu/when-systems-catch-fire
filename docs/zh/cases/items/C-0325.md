# [C-0325](C-0325.md)｜[D135](../../functions/items/D135.md)修正的工程含义 — CAI和EAI应使用部分不同的训练数据，降低G来提高ηgate
...
中文：
案例说明：[D135](../../functions/items/D135.md)修正的工程含义 — CAI和EAI应使用部分不同的训练数据，降低G来提高ηgate。核心函数：D80
...
中文：
[D135](../../functions/items/D135.md)修正的工程含义 — CAI和EAI应使用部分不同的训练数据，降低G来提高ηgate。核心函数：D80
