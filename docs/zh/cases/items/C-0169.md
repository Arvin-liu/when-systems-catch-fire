# [C-0169](C-0169.md)｜财商乘数四因子结构（验证[D65](../../functions/items/D65.md)财富域）
...
中文：
案例说明：财商乘数四因子结构（验证[D65](../../functions/items/D65.md)财富域）
...
中文：
财商乘数四因子结构（验证[D65](../../functions/items/D65.md)财富域）
