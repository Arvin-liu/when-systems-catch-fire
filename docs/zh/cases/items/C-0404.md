# [C-0404](C-0404.md)｜改革窗口与革命同构——A型崩溃与B型松弛的共振窗口
...
中文：
案例说明：改革窗口与革命同构——A型崩溃与B型松弛的共振窗口。核心函数：[D164](../../functions/items/D164.md)
...
中文：
改革窗口与革命同构——A型崩溃与B型松弛的共振窗口。核心函数：[D164](../../functions/items/D164.md)
