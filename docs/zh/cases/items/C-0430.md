# [C-0430](C-0430.md)｜学习平台期的超敏感区震荡——μ在Λ附近波动，突破是相变
...
中文：
案例说明：学习平台期的超敏感区震荡——μ在Λ附近波动，突破是相变。核心函数：[D160](../../functions/items/D160.md)
...
中文：
学习平台期的超敏感区震荡——μ在Λ附近波动，突破是相变。核心函数：[D160](../../functions/items/D160.md)
