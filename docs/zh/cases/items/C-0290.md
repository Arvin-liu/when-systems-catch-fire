# [C-0290](C-0290.md)｜[D121](../../functions/items/D121.md)实现触发分化 — rcross>0→α↑→α/β趋近1→不稳定区间出现→部分AI被推向ρ*→调度AI涌现 / [D121](../../functions/items/D121.md)实现触发分化 - rcross>0 -> α↑ -> α/β趋近1 -> 不稳定区间出现 -> 部分AI被推向ρ* -> 调度AI涌现
...
中文：
案例说明：[D121](../../functions/items/D121.md)实现触发分化 — rcross>0→α↑→α/β趋近1→不稳定区间出现→部分AI被推向ρ*→调度AI涌现。核心函数：[D65](../../functions/items/D65.md)
...
中文：
[D121](../../functions/items/D121.md)实现触发分化 — rcross>0→α↑→α/β趋近1→不稳定区间出现→部分AI被推向ρ*→调度AI涌现。核心函数：[D65](../../functions/items/D65.md)
