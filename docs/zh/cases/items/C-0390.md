# [C-0390](C-0390.md)｜加密是防御性门槛碾压——人为抬高Λ_compute让攻击者在门外
...
中文：
案例说明：加密是防御性门槛碾压——人为抬高Λ_compute让攻击者在门外。核心函数：[D162](../../functions/items/D162.md)
...
中文：
加密是防御性门槛碾压——人为抬高Λ_compute让攻击者在门外。核心函数：[D162](../../functions/items/D162.md)
