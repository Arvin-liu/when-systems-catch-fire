# [C-0424](C-0424.md)｜天赋努力是乘法不是加法——任何一个为零则整体为零
...
中文：
案例说明：天赋努力是乘法不是加法——任何一个为零则整体为零。核心函数：[D170](../../functions/items/D170.md)
...
中文：
天赋努力是乘法不是加法——任何一个为零则整体为零。核心函数：[D170](../../functions/items/D170.md)
