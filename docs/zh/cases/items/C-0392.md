# [C-0392](C-0392.md)｜分布式一致性的慢节点拖累——一个μ<Λ的节点拖累整体一致性
...
中文：
案例说明：分布式一致性的慢节点拖累——一个μ<Λ的节点拖累整体一致性。核心函数：[D163](../../functions/items/D163.md)
...
中文：
分布式一致性的慢节点拖累——一个μ<Λ的节点拖累整体一致性。核心函数：[D163](../../functions/items/D163.md)
