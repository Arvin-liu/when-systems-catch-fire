# [C-0402](C-0402.md)｜学习平台期的超敏感区——μ在Λ_next附近震荡，突破是相变
...
中文：
案例说明：学习平台期的超敏感区——μ在Λ_next附近震荡，突破是相变。核心函数：[D160](../../functions/items/D160.md)
...
中文：
学习平台期的超敏感区——μ在Λ_next附近震荡，突破是相变。核心函数：[D160](../../functions/items/D160.md)
