# [C-0163](C-0163.md)｜定投P_sustain全局最大值（验证[D34](../../functions/items/D34.md)） / 定投P_sustain全局最大值(验证[D34](../../functions/items/D34.md))
...
中文：
案例说明：定投P_sustain全局最大值（验证[D34](../../functions/items/D34.md)）
...
中文：
定投P_sustain全局最大值（验证[D34](../../functions/items/D34.md)）
