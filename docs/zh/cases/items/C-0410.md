# [C-0410](C-0410.md)｜慢性病的门外锁定+向下兼容——μ_repair<Λ_repair+症状管理的保真度损失
...
中文：
案例说明：慢性病的门外锁定+向下兼容——μ_repair<Λ_repair+症状管理的保真度损失。核心函数：[D159](../../functions/items/D159.md)×[D92](../../functions/items/D92.md)
...
中文：
慢性病的门外锁定+向下兼容——μ_repair<Λ_repair+症状管理的保真度损失。核心函数：[D159](../../functions/items/D159.md)×[D92](../../functions/items/D92.md)
