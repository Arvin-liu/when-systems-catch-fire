# [C-0423](C-0423.md)｜智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消
...
中文：
案例说明：智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消。核心函数：[D160](../../functions/items/D160.md)
...
中文：
智慧城市的名义vs实际——名义μ增长被Λ同步上升抵消。核心函数：[D160](../../functions/items/D160.md)
