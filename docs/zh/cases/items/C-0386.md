# [C-0386](C-0386.md)｜共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定
...
中文：
案例说明：共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定。核心函数：[D166](../../functions/items/D166.md)
...
中文：
共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定。核心函数：[D166](../../functions/items/D166.md)
