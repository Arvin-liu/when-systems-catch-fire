# [C-0335](C-0335.md)｜结构保守性vs手动保守 — 定投结构自动保守不需意志力，手动凯利牛市时H↑→高估E[r]→过度下注
...
中文：
案例说明：结构保守性vs手动保守 — 定投结构自动保守不需意志力，手动凯利牛市时H↑→高估E[r]→过度下注。核心函数：[D89](../../functions/items/D89.md)
...
中文：
结构保守性vs手动保守 — 定投结构自动保守不需意志力，手动凯利牛市时H↑→高估E[r]→过度下注。核心函数：[D89](../../functions/items/D89.md)
