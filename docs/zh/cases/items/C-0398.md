# [C-0398](C-0398.md)｜顿悟无中间态——μ越过Λ_awareness的瞬间相变，不存在"半懂"
...
中文：
案例说明：顿悟无中间态——μ越过Λ_awareness的瞬间相变，不存在"半懂"。核心函数：[D168](../../functions/items/D168.md)
...
中文：
顿悟无中间态——μ越过Λ_awareness的瞬间相变，不存在"半懂"。核心函数：[D168](../../functions/items/D168.md)
