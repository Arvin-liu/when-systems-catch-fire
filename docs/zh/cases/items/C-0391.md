# [C-0391](C-0391.md)｜NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度 / NP难是门槛指数碾压 - - Λ_compute∝2^n远超μ∝n^k的增长速度
...
中文：
案例说明：NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度。核心函数：[D160](../../functions/items/D160.md)
...
中文：
NP难是门槛指数碾压——Λ_compute∝2^n远超μ∝n^k的增长速度。核心函数：[D160](../../functions/items/D160.md)
