# C-0428｜元认知降低门槛——降低Λ_understanding的结构保守性策略 / 元认知降低门槛 - - 降低Λ_understanding的结构保守性策略
...
中文：
案例说明：元认知降低门槛——降低Λ_understanding的结构保守性策略。核心函数：D89
...
中文：
元认知降低门槛——降低Λ_understanding的结构保守性策略。核心函数：D89
