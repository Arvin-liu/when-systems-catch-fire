# [C-0414](C-0414.md)｜器官排斥的门槛翻转——异质组织降低Λ_immune导致自身免疫
...
中文：
案例说明：器官排斥的门槛翻转——异质组织降低Λ_immune导致自身免疫。核心函数：[D160](../../functions/items/D160.md)
...
中文：
器官排斥的门槛翻转——异质组织降低Λ_immune导致自身免疫。核心函数：[D160](../../functions/items/D160.md)
