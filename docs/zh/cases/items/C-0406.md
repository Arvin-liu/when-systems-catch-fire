# [C-0406](C-0406.md)｜威权的单点故障——单一B型正项维持，该正项消失则系统瞬间崩溃
...
中文：
案例说明：威权的单点故障——单一B型正项维持，该正项消失则系统瞬间崩溃。核心函数：[D161](../../functions/items/D161.md)
...
中文：
威权的单点故障——单一B型正项维持，该正项消失则系统瞬间崩溃。核心函数：[D161](../../functions/items/D161.md)
