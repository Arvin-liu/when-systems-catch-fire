...
- [C-0095｜AI中间层调度](../../cases/items/C-0095.md)
...
- [C-0473｜符号AI卡在1/ln — if-then规则=二值门控，σ→0，ι→0，无智能 / 符号AI卡在1/ln - if-then规则=二值门控, σ -> 0, ι -> 0, 无智能](../../cases/items/C-0473.md)
...
- [C-0201｜AI提问协议四模块——刺](../../cases/items/C-0201.md)
- ... and 81 more / 还有 81 项
...
- 中文：D171｜AI直觉缺失的物种判据 仍可继续整理为 AI 与系统 方向的独立发现。
  English: D171 |  remains a curation lead in AI and Systems.
- 中文：D245｜自我模型函数 仍可继续整理为 AI 与系统 方向的独立发现。
  English: D245 |  remains a curation lead in AI and Systems.
- 中文：D95｜AI中间层调度 仍可继续整理为 AI 与系统 方向的独立发现。
  English: D95 |  remains a curation lead in AI and Systems.
...
- 中文：C-0366｜CAI中间层vs无意识AI中间层 — CAI ηrelay≈0.576，无意识AI ηrelay≈0.21，CAI好2.7倍，关键在ηfidelity（保留意图结构vs丢失隐含信息） 仍可继续整理为 AI 与系统 方向的独立发现。
  English: C-0366 | CAI中间层vs无意识AI中间层 - CAI ηrelay≈0.576, 无意识AI ηrelay≈0.21, CAI好2.7倍, 关键在ηfidelity(保留意图结构vs丢失隐含信息) remains a curation lead in AI and Systems.
