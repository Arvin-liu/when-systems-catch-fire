# [D408](D408.md)｜Jensen-慢性消耗统一极限函数
...
- 定义域 / Domain: `X_{D408}`
- 值域 / Codomain: `Y_{D408}`
- 数学表达 / Expression: `F_{D408}(x) := M11的连续极限下Jensen项∝(dΦ/dt)²·τ_min/2。τ_min→0时Jensen→0，τ_min有限时Jensen有限。慢性消耗=有限τ_min下的Jensen效应。[D394](D394.md)"极限等价"需修正：不是严格等价而是τ_min有限时的近似等价。`
...
- 依赖 / Depends on: [D394](D394.md), [D408](D408.md)
- 推导步骤 / Steps:
