...
- 定义域 / Domain: `X_{D401}`
- 值域 / Codomain: `Y_{D401}`
- 数学表达 / Expression: `F_{D401}(x) := M4的Φ是零温自由能。有限温F = Φ - n·kT·ln2。临界温度kT_c~Φ/n∝ḡ——与[D387](D387.md)一致。点火框架与统计力学的等价性在零温极限下精确成立。`
