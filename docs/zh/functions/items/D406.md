...
- 定义域 / Domain: `X_{D406}`
- 值域 / Codomain: `Y_{D406}`
- 数学表达 / Expression: `F_{D406}(x) := M9的g_eff_macro = (1-R_irreversible)·g_eff。R→1时g_eff_macro→0但>0。与[D311](D311.md)微观僵尸态完全同构——宏观僵尸态是微观僵尸态在n→∞极限下的连续版本。`
