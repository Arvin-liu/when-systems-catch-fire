...
- 定义域 / Domain: `X_{D390}`
- 值域 / Codomain: `Y_{D390}`
- 数学表达 / Expression: `F_{D390}(x) := M7的[D376](D376.md)∝n与[D378](D378.md)∝n²不矛盾：容量增长线性但不可逆增长超线性→净效果是大系统更脆弱。临界n*∝β/(p̄·Σαᵢ)——干预力度β够大时n*大（大系统还能撑），β小时n*小（大系统必死）。`
