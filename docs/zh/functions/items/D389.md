...
- 定义域 / Domain: `X_{D389}`
- 值域 / Codomain: `Y_{D389}`
- 数学表达 / Expression: `F_{D389}(x) := M6的δ_c恰好是[D292](D292.md)吸引域的边界。吸引域深度∝Σαᵢ²/(1-pᵢ)²，δ_c∝1/√(Σαᵢ²/(1-pᵢ)²)——深度和δ_c是同一量的正反面。深度描述域内稳定性，δ_c描述域的边界。`
