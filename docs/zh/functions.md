...
### [MF-0000｜自举收敛判定器 / Bootstrap Convergence Judge](functions/meta/MF-0000.md)
...
| --- | --- | --- |
| [MF-0001](functions/meta/items/MF-0001.md) | 正向自举通道 / Forward Bootstrap Channel | 论证 x 成立 / Argues that x holds |
| [MF-0002](functions/meta/items/MF-0002.md) | 反向自举通道 / Reverse Bootstrap Channel | 论证 x 不成立 / Argues that x does not hold |
| [MF-0003](functions/meta/items/MF-0003.md) | 正反互斥判定器 / Forward-Reverse Exclusivity Judge | 检查正反是否同时通过 / Rejects simultaneous pass |
| [MF-0004](functions/meta/items/MF-0004.md) | 自举嵌套判定器 / Nested Bootstrap Judge | 检查自举元函数自身 / Tests bootstrap self-nesting |
| [MF-0005](functions/meta/items/MF-0005.md) | 自举收敛判定器 / Bootstrap Convergence Judge | 检查整个系统是否收敛 / Tests full-system convergence |
