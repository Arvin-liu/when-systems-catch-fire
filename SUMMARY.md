...
- [类型化变更传播闭包](./docs/architecture/typed-change-propagation.md) — 1.2.0 Draft candidate：构件解析、三类关系、同步联合闭包、fixpoint、系统图投影与 residue。
- [项目构件 registry](./data/operations/project-components.json) / [传播 topology](./data/operations/change-propagation-topology.json) — candidate 机器权威；不构成现实因果或项目完备性证明。
