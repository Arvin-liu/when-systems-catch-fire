...
- [增量执行与选择性物化](./docs/architecture/incremental-execution.md) — 1.3.0 Draft candidate：planner、NonImpactProof、profile-authorized executor、cache identity、validator 与 rollback/recovery。
