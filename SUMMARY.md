...
- [增量执行与选择性物化](./docs/architecture/incremental-execution.md) — 1.3.0 Draft candidate：执行能力分类、apply authority preflight、NonImpactProof、cache identity 与完整仓库 rollback/recovery。
