...
- [分离。机制 H 把审查矩阵分为硬门（事实、claim ceiling、受损／沉默主体，不可妥协）与可选项（金句密度、升华程度、段落形状，随文体浮动）。规格增补的“朗读与反套路审查矩阵”字段也按此二分。](../../../reports/publication/zhiyuan-writing-cognitive-migration-editorial-revision-review.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-7101c62b7d46ae25 / 分离。机制 H 把审查矩阵分为硬门（事实、claim ceiling、受损／沉默主体，不可妥协）与可选项（金句密度、升华程度、段落形状，随文体浮动）。规格增补的“朗读与反套路审查矩阵”字段也按此二分。
...
- [加法退化验证 — 同一系统改为加法G=∑fi,Fisher距离有限,A_Fisher不再单调递减,dS](../../../data/foundation/evidence/evidence.jsonl)
  ...
  - 依赖：—；被引用：—
- [动刀前先判断草稿的主导问题类型，依此选择编辑压力。它不是僵化的文体分类法，只是决定“先改哪里、改多重”的入口：](../../../docs/publication/zhiyuan-writing-cognitive-migration-editorial-revision.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-1a54b7afd78b8bfd / 动刀前先判断草稿的主导问题类型，依此选择编辑压力。它不是僵化的文体分类法，只是决定“先改哪里、改多重”的入口：
...
- [原始材料：`inputs/collisions/20260708-teacher-competition/source.md`（Get 笔记《赛课机制下的教师生存困境》）](../../../outputs/audit/teacher-competition-backfill-review-20260708.md)
  ...
  - 依赖：—；被引用：—
- [原始笔记含受得到大脑影响的用户蒸馏内容，依边界不进入正式仓库；本记录不复制其正文，仅以指纹与转化后机制留存。](../../../docs/publication/method-sources/cognitive-migration-editorial-revision-source.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-d31023bac728f69b / 原始笔记含受得到大脑影响的用户蒸馏内容，依边界不进入正式仓库；本记录不复制其正文，仅以指纹与转化后机制留存。
...
- [它的边界意识和失败机制，正是为了防止跨域思考滑向万能论。](../../../docs/author_motivation_and_boundary_note.md)
  ...
  - 依赖：—；被引用：—
- [完整机制、与源笔记的来源边界、四个 before/after 微案例与审查结论见：](../../../docs/publication/zhiyuan-writing-method.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `PENDING_EMPIRICAL_TEST`
  - 可搜索名称：NFC-92a1670e616cf566 / 完整机制、与源笔记的来源边界、四个 before/after 微案例与审查结论见：
  - 来源：`docs/publication/zhiyuan-writing-method.md`
  - 依赖：—；被引用：—
...
- [新增注释 · 赛课机制下的教师生存困境](../../../outputs/collisions/20260708-teacher-competition/notes.md)
  ...
  - 来源：`outputs/collisions/20260708-teacher-competition/notes.md`
  - 依赖：—；被引用：—
- [新增能力真实性**：通过。子模块提出生成阶段没有的编辑修订机制，非重述。](../../../reports/publication/zhiyuan-writing-cognitive-migration-editorial-revision-review.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-537c4983db7ca850 / 新增能力真实性**：通过。子模块提出生成阶段没有的编辑修订机制，非重述。
  - 来源：`reports/publication/zhiyuan-writing-cognitive-migration-editorial-revision-review.md`
  - 依赖：—；被引用：—
...
- [本文件纠正 084 报告中对生成机制和命题真值的不准确描述。所有纠正基于 `084-max-decisions.jsonl` 的机器可读真值重算，不修改 084 原始文件。](../../../reports/foundation-architecture/085-084-truth-status-correction.md)
  ...
  - 来源：`reports/foundation-architecture/085-084-truth-status-correction.md`
  - 依赖：—；被引用：—
- [本文是\[认知迁移编辑修订子模块\](../../../docs/publication/zhiyuan-writing-cognitive-migration-editorial-revision.md)的来源与版权边界记录。**原始笔记不进入正式仓库**，此处只保留可审计的来源指纹、经过](../../../docs/publication/method-sources/cognitive-migration-editorial-revision-source.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-1d6c36ee0a62fc56 / 本文是\[认知迁移编辑修订子模块\](../../../docs/publication/zhiyuan-writing-cognitive-migration-editorial-revision.md)的来源与版权边界记录。**原始笔记不进入正式仓库**，此处只保留可审计的来源指纹、经过
  - 来源：`docs/publication/method-sources/cognitive-migration-editorial-revision-source.md`
  - 依赖：—；被引用：—
...
- [核心规则：**每个被合并的能力、被接受的方法、被批准的治理决定，必须记录其作出时所依宪章版本（`charter_version_at_decision`）**。](../../../docs/governance/charter-system-r1.md)
  ...
  - 来源：`docs/governance/charter-system-r1.md`
  - 依赖：—；被引用：—
- [案例 6：驳回夸大金句（反套路审查，机制 H）](../../../docs/publication/zhiyuan-writing-cognitive-migration-editorial-revision-examples.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `PENDING_EMPIRICAL_TEST`
  - 可搜索名称：NFC-a2084930fb739b23 / 案例 6：驳回夸大金句（反套路审查，机制 H）
...
- [此前独立部署的阅读站已退出产品与同步面，独有系统图迁移到 \[仓库内 SVG\](../../../docs/generated/ignition-system-map.svg)。历史部署证据仍留在 Git 与旧报告，不再构成当前完成门禁。](../../../docs/project-current-state.md)
  ...
  - 依赖：—；被引用：—
- [此句即使“适合截图”也必须拒。机制 H 把“截图向金句”列为审查项，且硬事实门不可妥协。](../../../docs/publication/zhiyuan-writing-cognitive-migration-editorial-revision-examples.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `ACCEPTED_AS_DEFINITION`
  - 可搜索名称：NFC-57de745c1dacbc55 / 此句即使“适合截图”也必须拒。机制 H 把“截图向金句”列为审查项，且硬事实门不可妥协。
  - 来源：`docs/publication/zhiyuan-writing-cognitive-migration-editorial-revision-examples.md`
  - 依赖：—；被引用：—
...
- [混沌理论与点火框架非线性演化协议（E₂）的同构性。微小偏差被反复放大，验证了非线性演化协议对系统演化的决定性作用。](../../../data/foundation/arguments/arguments.jsonl)
  ...
  - 来源：`data/foundation/arguments/arguments.jsonl`
  - 依赖：—；被引用：—
- [源机制到子模块的转化映射（摘要）](../../../docs/publication/method-sources/cognitive-migration-editorial-revision-source.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `PENDING_EMPIRICAL_TEST`
  - 可搜索名称：NFC-33c907cfed64cbe8 / 源机制到子模块的转化映射（摘要）
  - 来源：`docs/publication/method-sources/cognitive-migration-editorial-revision-source.md`
  - 依赖：—；被引用：—
