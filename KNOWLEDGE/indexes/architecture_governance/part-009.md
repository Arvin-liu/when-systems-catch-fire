...
- [Non-Sycophancy Output Protocol](../../ASSET-CARDS.md#asset-hr-70403729fef8b50e)
  ...
  - 依赖：—；被引用：—
- [Nonfunction closure: `54/54`, `NONFUNCTION_CLAIM_EVIDENCE_LINEAGE_CLOSURE_VALID`.](../../../reports/validation/pointfire-seven-track-current-main-maintenance-r1-20260813.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-b6111dbb0268ebe2 / Nonfunction closure: `54/54`, `NONFUNCTION_CLAIM_EVIDENCE_LINEAGE_CLOSURE_VALID`.
...
- [projection = render_projection(registry)](../../../tests/test_stage_snapshot_publication.py)
  ...
  - 依赖：—；被引用：—
- [projection from claim/function discovery while keeping it accountable to the](../../../reports/validation/pointfire-seven-track-current-main-maintenance-r1-20260813.md)
  - 类型/状态：`NONFUNCTION_CLAIM` · `HISTORICAL_ONLY`
  - 可搜索名称：NFC-3b13a0b3155be698 / projection from claim/function discovery while keeping it accountable to the
  - 来源：`reports/validation/pointfire-seven-track-current-main-maintenance-r1-20260813.md`
  - 依赖：—；被引用：—
