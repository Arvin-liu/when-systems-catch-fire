#!/usr/bin/env python3
"""F15-D1 repair-r2 contract test (RB09-DIRECT-PREDECESSOR-BINDING + inherited engine)."""
import json, subprocess, sys, tempfile, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[2]
VALIDATOR = ROOT / "tools/latent/validate_latent_system_identifiability_gate.py"
PILOT = ROOT / "data/latent/pilot-f15-d1-i1.json"
CORRECT_HEAD = "e92e7d3eadbb67da288077052f635e3c052bd3a1"
