...
class CapabilityGateTests(unittest.TestCase):
 ...
 def test_q41_predecessor_regression(self):
  q41_pilot=ROOT/"data/anomaly/pilot-q41-i1.json"
  q41_validator=ROOT/"tools/anomaly/validate_world_feedback_anomaly_gate.py"
  r=subprocess.run([sys.executable,str(q41_validator),"--bundle",str(q41_pilot)],capture_output=True,text=True)
