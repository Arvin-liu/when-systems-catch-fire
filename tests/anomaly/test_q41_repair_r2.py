#!/usr/bin/env python3
"""Q41 repair-r2 contract test (RB09-DIRECT-PREDECESSOR-BINDING + inherited engine)."""
import json, subprocess, sys, tempfile, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[2]
VALIDATOR = ROOT / "tools/anomaly/validate_world_feedback_anomaly_gate.py"
PILOT = ROOT / "data/anomaly/pilot-q41-i1.json"
CORRECT_HEAD = "25f937ea8d53b4b14f31fc9c8779995f3c516bac"
