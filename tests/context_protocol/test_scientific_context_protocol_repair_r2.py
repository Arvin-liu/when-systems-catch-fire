#!/usr/bin/env python3
"""SCIENTIFIC-CONTEXT-PROTOCOL repair-r2 contract test (RB09-DIRECT-PREDECESSOR-BINDING + inherited engine)."""
import json, subprocess, sys, tempfile, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[2]
VALIDATOR = ROOT / "tools/context_protocol/validate_open_scientific_context_protocol_gate.py"
PILOT = ROOT / "data/context_protocol/pilot-scientific-context-protocol-i1.json"
CORRECT_HEAD = "7532b4b34cf841c09faab8c835c5fc7f896d30d8"
