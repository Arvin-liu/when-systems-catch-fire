#!/usr/bin/env python3
"""SCIENTIFIC-METACOGNITION repair-r2 contract test (RB09-DIRECT-PREDECESSOR-BINDING + inherited engine)."""
import json, subprocess, sys, tempfile, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[2]
VALIDATOR = ROOT / "tools/metacognition/validate_epistemic_state_control_plane_gate.py"
PILOT = ROOT / "data/metacognition/pilot-scientific-metacognition-i1.json"
CORRECT_HEAD = "1a51d1b3fd1bab4eb1c80a7429e0b629bcae69a9"
