#!/usr/bin/env python3
"""D2 repair-r2 contract test (RB09-DIRECT-PREDECESSOR-BINDING + inherited engine)."""
import json, subprocess, sys, tempfile, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[2]
VALIDATOR = ROOT / "tools/multihistory/validate_multi_history_world_projection_gate.py"
PILOT = ROOT / "data/multihistory/pilot-d2-i1.json"
CORRECT_HEAD = "95405ae791dc0359c2ab6597bfd7c50224c2c59c"
