#!/usr/bin/env python3
"""Q44 repair-r2 contract test (RB09-DIRECT-PREDECESSOR-BINDING + inherited engine)."""
import json, subprocess, sys, tempfile, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[2]
VALIDATOR = ROOT / "tools/coaching/validate_coaching_commitment_subcapability_gate.py"
PILOT = ROOT / "data/coaching/pilot-q44-i1.json"
CORRECT_HEAD = "e5181c83efba68f847b55e13c7b5a1ee1fd6888e"
