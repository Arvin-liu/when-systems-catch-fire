...
- Candidate narrow repair: the PR #134 responsibility fields now require structured accountable `PERSON`/`ORGANIZATION` actors, separate execution agents/workflows, stable A15c/A15d mutation cases and explicit responsibility revision history. PR #134 and method 1.4.0 remain Draft/Candidate; Main and production Pages are unchanged.
- Candidate R2 narrow repair: after PR #135 exact head `567aef78345564adb646b59590924cf24f4bbc45` was rejected, final responsibility now uses controlled ACTIVE `actor_ref` identities, both public Schemas derive the same allowed reference set from the actor registry, runtime resolves that registry, and the stable runner requires Schema/runtime agreement. This does not accept PR #135/#134, change Main, deploy production Pages or promote method 1.4.0.
