...
- R5-A consolidated contract-bypass narrow repair (Draft, awaiting independent exact-head review): independently replayed `R5A-CR-001`–`011` as accepted on rejected head `f33be64b...`, then closed every exact runtime/standard-schema path with one concrete fixture, typed evidence, expected rejection and executed per-surface result. All six public schemas now declare Draft 2020-12, pass metaschema and valid/invalid instance checks; missing, duplicate, changed-expectation, bypass-restoring and deleted-ID mutations block. Fourteen artifacts regenerate deterministically. This is implementation evidence only, not Ready/accepted/merged/Main/Current and not permission for R5-B/R5-C/R6.
