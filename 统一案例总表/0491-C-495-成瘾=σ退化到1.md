...
id: "C-495"
raw_id: "#495"
title: "成瘾=σ退化到1/ln — 从连续优化退回二值判断（要/不要），失去中间态"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 19677
link: "docs/zh/cases/items/C-0495.md"
---
...
**发现 / Discovery**
中文：成瘾=σ退化到1/ln — 从连续优化退回二值判断（要/不要），失去中间态。核心函数：[D227](docs/zh/functions/items/D2…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：成瘾=σ退化到1/ln — 从连续优化退回二值判断（要/不要），失去中间态。核心函数：[D227](docs/zh/fun… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0491-C-495-成瘾=σ退化到1.md`
