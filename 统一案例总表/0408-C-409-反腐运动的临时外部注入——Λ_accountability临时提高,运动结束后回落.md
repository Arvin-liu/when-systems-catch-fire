...
id: "C-409"
raw_id: "#409"
title: "反腐运动的临时外部注入——Λ_accountability临时提高，运动结束后回落"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 16272
link: "docs/zh/cases/items/C-0409.md"
---
...
**发现 / Discovery**
中文：反腐运动的临时外部注入——Λ_accountability临时提高，运动结束后回落。核心函数：[D161](docs/zh/functions/item…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：反腐运动的临时外部注入——Λ_accountability临时提高，运动结束后回落。核心函数：[D161](docs/zh… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0408-C-409-反腐运动的临时外部注入——Λ_accountability临时提高,运动结束后回落.md`
