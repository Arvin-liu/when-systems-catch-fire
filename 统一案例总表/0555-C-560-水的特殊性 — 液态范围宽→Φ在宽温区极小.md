...
id: "C-560"
raw_id: "#560"
title: "水的特殊性 — 液态范围宽→Φ在宽温区极小"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 22243
link: "docs/zh/cases/items/C-0560.md"
---
...
**发现 / Discovery**
中文：水的特殊性 — 液态范围宽→Φ在宽温区极小。核心函数：[D158](docs/zh/functions/items/D158.md) English:…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：水的特殊性 — 液态范围宽→Φ在宽温区极小。核心函数：[D158](docs/zh/functions/items/D15… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
