...
id: "C-556"
raw_id: "#556"
title: "衰老 — Φ线性增长→B指数衰减→Gompertz定律 / 衰老 - Φ线性增长 -> B指数衰减 -> Gompertz定律"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 22087
link: "docs/zh/cases/items/C-0556.md"
---
...
**发现 / Discovery**
中文：衰老 — Φ线性增长→B指数衰减→Gompertz定律。核心函数：[D158](docs/zh/functions/items/D158.md) Eng…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：衰老 — Φ线性增长→B指数衰减→Gompertz定律。核心函数：[D158](docs/zh/functions/ite… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0551-C-556-衰老 — Φ线性增长→B指数衰减→Gompertz定律.md`
