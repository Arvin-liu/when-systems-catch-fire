...
source_line: 5749
link: "docs/zh/cases/items/C-0144.md"
---
...
**推测 / Hypothesis**
从这条案例看，中文：案例说明：R_upgrade=R₀×∫[α₁Δ(信息可及性)+α₂(-ΔC_exit_eff)+α₃Δε_aware]dt 关键发现… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0144-C-144-县城佳和超市90%复购率.md`
