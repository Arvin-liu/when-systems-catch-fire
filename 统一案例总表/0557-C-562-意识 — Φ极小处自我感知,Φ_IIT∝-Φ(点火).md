...
id: "C-562"
raw_id: "#562"
title: "意识 — Φ极小处自我感知，Φ_IIT∝-Φ(点火) / 意识 - Φ极小处自我感知, Φ_IIT∝-Φ(Ignition)"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 22326
link: "docs/zh/cases/items/C-0562.md"
---
...
**发现 / Discovery**
中文：意识 — Φ极小处自我感知，Φ_IIT∝-Φ(点火)。核心函数：[D158](docs/zh/functions/items/D158.md) Engl…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：意识 — Φ极小处自我感知，Φ_IIT∝-Φ(点火)。核心函数：[D158](docs/zh/functions/item… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0557-C-562-意识 — Φ极小处自我感知,Φ_IIT∝-Φ(点火).md`
