...
source_line: 3953
link: "docs/zh/cases/items/C-0099.md"
---
...
**发现 / Discovery**
中文：自锁结构 — 认知锁×行动锁，应约者成了自己的狱卒 English: Rule-based English rendering pending huma…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：自锁结构 — 认知锁×行动锁，应约者成了自己的狱卒 English: Rule-based English renderi… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0099-C-99-自锁结构.md`
