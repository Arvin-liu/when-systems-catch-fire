...
id: "C-224"
raw_id: "#224"
title: "退出概率=阿伦尼乌斯方程 / exit probability=阿伦尼乌斯方程"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 8931
link: "docs/zh/cases/items/C-0224.md"
---
...
**发现 / Discovery**
中文：退出概率=阿伦尼乌斯方程——ε是认知温度，C_exit是活化能 English: Rule-based English rendering pendin…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：退出概率=阿伦尼乌斯方程——ε是认知温度，C_exit是活化能 English: Rule-based English r… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0224-C-224-退出概率=阿伦尼乌斯方程.md`
