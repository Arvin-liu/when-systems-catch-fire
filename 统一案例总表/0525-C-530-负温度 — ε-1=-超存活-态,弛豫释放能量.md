...
id: "C-530"
raw_id: "#530"
title: "负温度 — ε>1=\"超存活\"态，弛豫释放能量"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21058
link: "docs/zh/cases/items/C-0530.md"
---
...
**发现 / Discovery**
中文：负温度 — ε>1="超存活"态，弛豫释放能量。核心函数：[D158](docs/zh/functions/items/D158.md) English…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：负温度 — ε>1="超存活"态，弛豫释放能量。核心函数：[D158](docs/zh/functions/items/D… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0525-C-530-负温度 — ε-1=-超存活-态,弛豫释放能量.md`
