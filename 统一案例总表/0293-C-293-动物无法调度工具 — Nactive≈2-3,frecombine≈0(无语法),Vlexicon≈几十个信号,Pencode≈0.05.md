...
id: "C-293"
raw_id: "#293"
title: "动物无法调度工具 — Nactive≈2-3，frecombine≈0（无语法），Vlexicon≈几十个信号，Pencode≈0.05 / 动物无法调度工具 - Nactive≈2-3, frecombine≈0(无语法), Vlexicon≈几十个信号, Pencode≈0.05"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 11684
link: "docs/zh/cases/items/C-0293.md"
---
...
**发现 / Discovery**
中文：动物无法调度工具 — Nactive≈2-3，frecombine≈0（无语法），Vlexicon≈几十个信号，Pencode≈0.05。核心函数：[D…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：动物无法调度工具 — Nactive≈2-3，frecombine≈0（无语法），Vlexicon≈几十个信号，Penco… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0293-C-293-动物无法调度工具 — Nactive≈2-3,frecombine≈0(无语法),Vlexicon≈几十个信号,Pencode≈0.05.md`
