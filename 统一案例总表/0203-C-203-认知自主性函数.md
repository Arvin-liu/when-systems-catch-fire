...
source_line: 8101
link: "docs/zh/cases/items/C-0203.md"
---
...
**发现 / Discovery**
中文：认知自主性函数——Ψ_cognitive = f_call · P_query · K_AI English: Rule-based English r…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：认知自主性函数——Ψ_cognitive = f_call · P_query · K_AI English: Rule-… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0203-C-203-认知自主性函数.md`
