...
id: "C-386"
raw_id: "#386"
title: "共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 15362
link: "docs/zh/cases/items/C-0386.md"
---
...
**发现 / Discovery**
中文：共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定。核心函数：[D166](docs/zh/functions/items/D166.m…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定。核心函数：[D166](docs/zh/functio… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0385-C-386-共生是互为外部注入——两个物种互为对方的外部注入打破各自的门外锁定.md`
