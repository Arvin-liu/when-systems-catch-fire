...
id: "C-406"
raw_id: "#406"
title: "威权的单点故障——单一B型正项维持，该正项消失则系统瞬间崩溃"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 16155
link: "docs/zh/cases/items/C-0406.md"
---
...
**推测 / Hypothesis**
从这条案例看，中文：案例说明：威权的单点故障——单一B型正项维持，该正项消失则系统瞬间崩溃。核心函数：[D161](docs/zh/functions/… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0405-C-406-威权的单点故障——单一B型正项维持,该正项消失则系统瞬间崩溃.md`
