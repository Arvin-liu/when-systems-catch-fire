...
id: "C-532"
raw_id: "#532"
title: "信息熵vs热力学熵 — S_thermo=Φ在粗粒化下的投影"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21141
link: "docs/zh/cases/items/C-0532.md"
---
...
**推测 / Hypothesis**
从这条案例看，中文：案例说明：信息熵vs热力学熵 — S_thermo=Φ在粗粒化下的投影。核心函数：[D158](docs/zh/functions/… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0527-C-532-信息熵vs热力学熵 — S_thermo=Φ在粗粒化下的投影.md`
