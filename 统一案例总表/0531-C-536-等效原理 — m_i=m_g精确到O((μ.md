...
id: "C-536"
raw_id: "#536"
title: "等效原理 — m_i=m_g精确到O((μ/M_Planck)²)，强场失效 / 等效原理 - m_i=m_g精确到O((μ/M_Planck)²), 强场失效"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21297
link: "docs/zh/cases/items/C-0536.md"
---
...
**发现 / Discovery**
中文：等效原理 — m_i=m_g精确到O((μ/M_Planck)²)，强场失效。核心函数：[D158](docs/zh/functions/items/D…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：等效原理 — m_i=m_g精确到O((μ/M_Planck)²)，强场失效。核心函数：[D158](docs/zh/fu… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0531-C-536-等效原理 — m_i=m_g精确到O((μ.md`
