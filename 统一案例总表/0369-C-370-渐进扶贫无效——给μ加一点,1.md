...
id: "C-370"
raw_id: "#370"
title: "渐进扶贫无效——给μ加一点，1/ln从-∞变成很大负数，几乎没改善；必须让μ越过Λ_econ"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 14727
link: "docs/zh/cases/items/C-0370.md"
---
...
**发现 / Discovery**
中文：渐进扶贫无效——给μ加一点，1/ln从-∞变成很大负数，几乎没改善；必须让μ越过Λ_econ。核心函数：[D159](docs/zh/functions…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：渐进扶贫无效——给μ加一点，1/ln从-∞变成很大负数，几乎没改善；必须让μ越过Λ_econ。核心函数：[D159](do… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0369-C-370-渐进扶贫无效——给μ加一点,1.md`
