...
id: "C-384"
raw_id: "#384"
title: "有性繁殖的倒U型——繁殖成本与基因多样性之间的两个死锁，有性繁殖是唯一通路"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 15283
link: "docs/zh/cases/items/C-0384.md"
---
...
**发现 / Discovery**
中文：有性繁殖的倒U型——繁殖成本与基因多样性之间的两个死锁，有性繁殖是唯一通路。核心函数：[D90](docs/zh/functions/items/D90…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：有性繁殖的倒U型——繁殖成本与基因多样性之间的两个死锁，有性繁殖是唯一通路。核心函数：[D90](docs/zh/func… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0383-C-384-有性繁殖的倒U型——繁殖成本与基因多样性之间的两个死锁,有性繁殖是唯一通路.md`
