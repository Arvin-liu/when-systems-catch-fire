...
id: "C-387"
raw_id: "#387"
title: "病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 15401
link: "docs/zh/cases/items/C-0387.md"
---
...
**发现 / Discovery**
中文：病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态。核心函数：[D167](docs/zh/functions/items/D167.md) En…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：病毒的门控面切换——寄生前σ=0寄生后σ=1，没有中间态。核心函数：[D167](docs/zh/functions/it… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0386-C-387-病毒的门控面切换——寄生前σ=0寄生后σ=1,没有中间态.md`
