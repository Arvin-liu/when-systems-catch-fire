...
id: "C-373"
raw_id: "#373"
title: "威权稳定的B型锁定——危机时A型门控全塌，B型门控成为唯一正项，系统被锁在低存活度但非零状态"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 14849
link: "docs/zh/cases/items/C-0373.md"
---
...
**发现 / Discovery**
中文：威权稳定的B型锁定——危机时A型门控全塌，B型门控成为唯一正项，系统被锁在低存活度但非零状态。核心函数：[D161](docs/zh/functions…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：威权稳定的B型锁定——危机时A型门控全塌，B型门控成为唯一正项，系统被锁在低存活度但非零状态。核心函数：[D161](do… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0372-C-373-威权稳定的B型锁定——危机时A型门控全塌,B型门控成为唯一正项,系统被锁在低存活度但非零状态.md`
