...
id: "C-531"
raw_id: "#531"
title: "相变分类 — 连续=穿越超平面，一级=两存活区跳变"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 21102
link: "docs/zh/cases/items/C-0531.md"
---
...
**发现 / Discovery**
中文：相变分类 — 连续=穿越超平面，一级=两存活区跳变。核心函数：[D158](docs/zh/functions/items/D158.md) Engli…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：相变分类 — 连续=穿越超平面，一级=两存活区跳变。核心函数：[D158](docs/zh/functions/items… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0526-C-531-相变分类 — 连续=穿越超平面,一级=两存活区跳变.md`
