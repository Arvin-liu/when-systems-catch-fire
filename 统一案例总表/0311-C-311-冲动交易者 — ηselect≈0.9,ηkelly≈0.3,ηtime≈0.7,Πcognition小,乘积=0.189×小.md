...
id: "C-311"
raw_id: "#311"
title: "冲动交易者 — ηselect≈0.9，ηkelly≈0.3，ηtime≈0.7，Πcognition小，乘积=0.189×小 / 冲动交易者 - ηselect≈0.9, ηkelly≈0.3, ηtime≈0.7, Πcognition小, 乘积=0.189 x 小"
source: "点火 | 统一案例总表.675版.2026.06.18.00.18.md"
source_line: 12396
link: "docs/zh/cases/items/C-0311.md"
---
...
**发现 / Discovery**
中文：冲动交易者 — ηselect≈0.9，ηkelly≈0.3，ηtime≈0.7，Πcognition小，乘积=0.189×小。核心函数：[D76](d…

**推测 / Hypothesis**
从这条案例看，中文：案例说明：冲动交易者 — ηselect≈0.9，ηkelly≈0.3，ηtime≈0.7，Πcognition小，乘积=0.189… 更像是在验证“退出权、认同和函数映射”之间的对应关系。
...
**原文来源 / Source**：`/Users/zhiyuan/我的笔记/统一案例总表/0311-C-311-冲动交易者 — ηselect≈0.9,ηkelly≈0.3,ηtime≈0.7,Πcognition小,乘积=0.189×小.md`
