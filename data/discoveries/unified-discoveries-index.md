...
| DISC-0084 | [状态时间是序列计数投影，不是外部本体假设 / State time is a sequence-count projection, not an external ontology assumption](docs/zh/discoveries/items/DISC-0084.md) | Physics, Neuroscience and Consciousness, Philosophy | active_pending_novelty_review | inconclusive | 2 | 2 |
| DISC-0085 | [维度可作为解释压缩坐标，而非对象固有标签 / Dimension can be an explanatory compression coordinate rather than an intrinsic label](docs/zh/discoveries/items/DISC-0085.md) | Physics, Philosophy, Technology and Engineering | active_pending_novelty_review | inconclusive | 3 | 0 |
| DISC-0086 | [黑洞边界可表达为自维持系统的外部信息失配 / A black-hole boundary can be expressed as external information mismatch in a self-maintaining system](docs/zh/discoveries/items/DISC-0086.md) | Physics, AI and Systems, Philosophy | active_pending_novelty_review | inconclusive | 3 | 1 |
| DISC-0087 | [生命式系统需要主动变体生成，而不只是被动复制 / Life-like systems require active variant generation, not only passive copying](docs/zh/discoveries/items/DISC-0087.md) | Biology, AI and Systems, Sociology and Politics | active_pending_novelty_review | inconclusive | 2 | 4 |
| DISC-0088 | [形式系统外推必须保留可证明、可反驳、独立与欠定四个出口 / Formal-system extrapolation must keep provable, refutable, independent, and underdetermined exits](docs/zh/discoveries/items/DISC-0088.md) | Philosophy, Technology and Engineering, AI and Systems | active_pending_novelty_review | inconclusive | 1 | 0 |
